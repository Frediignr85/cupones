...
class ModeloHistorial extends Model
{
    ...
    function traer_historial_compras($id_cliente){
        $sql = "SELECT tblcompra_general.id_compra_general, tblcompra_general.total_compra, tblcompra_general.numero_tarjeta, (SELECT SUM(tblcompra_detalle.cantidad) FROM tblcompra_detalle INNER JOIN tblcompra_especifica on tblcompra_especifica.id_compra_especifica = tblcompra_detalle.id_compra_especifica INNER JOIN tblcompra_general as compra_general1 on compra_general1.id_compra_general = tblcompra_especifica.id_compra_general WHERE compra_general1.id_compra_general = tblcompra_general.id_compra_general) as 'cantidad_cupones', (SELECT SUM(tblcompra_detalle.cantidad) FROM tblcompra_detalle INNER JOIN tbloferta on tbloferta.id_oferta = tblcompra_detalle.id_oferta INNER JOIN tblcompra_especifica on tblcompra_especifica.id_compra_especifica = tblcompra_detalle.id_compra_especifica INNER JOIN tblcompra_general as compra_general1 on compra_general1.id_compra_general = tblcompra_especifica.id_compra_general WHERE compra_general1.id_compra_general = tblcompra_general.id_compra_general AND tblcompra_detalle.canjeada = 1 ) as 'cupones_canjeados', (SELECT SUM(tblcompra_detalle.cantidad) FROM tblcompra_detalle INNER JOIN tbloferta on tbloferta.id_oferta = tblcompra_detalle.id_oferta INNER JOIN tblcompra_especifica on tblcompra_especifica.id_compra_especifica = tblcompra_detalle.id_compra_especifica INNER JOIN tblcompra_general as compra_general1 on compra_general1.id_compra_general = tblcompra_especifica.id_compra_general WHERE compra_general1.id_compra_general = tblcompra_general.id_compra_general AND tblcompra_detalle.canjeada = 0 AND CURDATE() <= tbloferta.fecha_limite ) as 'cupones_no_canjeados', (SELECT SUM(tblcompra_detalle.cantidad) FROM tblcompra_detalle INNER JOIN tbloferta on tbloferta.id_oferta = tblcompra_detalle.id_oferta INNER JOIN tblcompra_especifica on tblcompra_especifica.id_compra_especifica = tblcompra_detalle.id_compra_especifica INNER JOIN tblcompra_general as compra_general1 on compra_general1.id_compra_general = tblcompra_especifica.id_compra_general WHERE compra_general1.id_compra_general = tblcompra_general.id_compra_general AND tblcompra_detalle.canjeada = 0 AND CURDATE() > tbloferta.fecha_limite ) as 'cupones_vencidos' FROM tblcompra_general WHERE tblcompra_general.deleted_at is NULL AND tblcompra_general.id_cliente = '$id_cliente'";
        $data = $this->db->query($sql);
        return $data;
    }
    function traer_datos_compra_general($id_compra_general){
        $sql = "SELECT tblempresa_ofertante.nombre, tbloferta.titulo_oferta, tbloferta.precio_oferta,tblcompra_detalle.canjeada, tblcompra_detalle.cantidad FROM tblcompra_detalle INNER JOIN tbloferta on tbloferta.id_oferta = tblcompra_detalle.id_oferta INNER JOIN tblcompra_especifica on tblcompra_especifica.id_compra_especifica = tblcompra_detalle.id_compra_especifica INNER JOIN tblempresa_ofertante on tblempresa_ofertante.id_empresa = tblcompra_especifica.id_empresa INNER JOIN tblcompra_general on tblcompra_general.id_compra_general = tblcompra_especifica.id_compra_general WHERE tblcompra_general.id_compra_general = '$id_compra_general'";
        $data = $this->db->query($sql);
        return $data;
    }
