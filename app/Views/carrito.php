        ...
        <div class="navigation">
            <div class="container">
                ...
                <div class="nav__hamburger">
                    ...
                    <div class="nav__logo">
                        <a href="<?php echo base_url("/inicio"); ?>" class="scroll-link">
                            UIS
                        </a>
                    </div>
                    ...
                    <div class="nav__menu">
                        <div class="menu__top">
                            <span class="nav__category">UIS</span>
                        ...
                        <ul class="nav__list">
                            <li class="nav__item">
                                <a href="<?php echo base_url("/inicio"); ?>" class="nav__link scroll-link">Inicio</a>
                            </li>
                        </ul>
                    </div>
                    <?php
            ...
            <div class="container">
                <div class="page__title-container">
                    <ul class="page__titles">
                        ...
                        <li class="page__title">Carrito</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="footer__top">
                ...
                <div class="footer-top__box">
                    <h3>MI CUENTA</h3>
                    <a href="#">Mi cuenta</a>
                    <a href="<?php echo base_url("/historial"); ?>">Historial de Compras</a>
                    <a href="#">Carrito</a>
                </div>
                <div class="footer-top__box">
                    <h3>CONTACTANOS</h3>
