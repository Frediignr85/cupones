            ...
            <div class="container">
                <nav class="nav">
                    ...
                    <div class="nav__icons">
                        <a data-toggle='modal' href="<?php echo base_url("/password"); ?>"  data-target='#deleteModal' data-refresh='true' class="icon__item">
                            <svg class="icon__user">
                                <use xlink:href="<?php echo base_url("assets/images/sprite.svg#icon-user"); ?>"></use>
                            </svg>
                        </a>
            ...
            <div class="glide" id="glide_1">
                ...
                <div class="glide__arrows" data-glide-el="controls">
                    <button class="glide__arrow glide__arrow--left" data-glide-dir="<">
                        <svg>
                            <use xlink:href="<?php echo base_url("assets/images/sprite.svg#icon-arrow-left2"); ?>">
                            </use>
                        </svg>
                    </button>
                    <button class="glide__arrow glide__arrow--right" data-glide-dir=">">
                        <svg>
                            <use xlink:href="<?php echo base_url("assets/images/sprite.svg#icon-arrow-right2"); ?>">
                            </use>
                        </svg>
                    </button>
                </div>
            ...
            <section class="section latest__products" id="latest">
                <div class="title__container">
                    <div class="section__title active" data-id="Latest Products">
                        <span class="dot"></span>
                        <h1 class="primary__title">Ultimos Productos</h1>
                    </div>
                </div>
                    ...
                    <div class="glide" id="glide_2">
                        ...
                        <div class="glide__arrows" data-glide-el="controls">
                            <button class="glide__arrow glide__arrow--left" data-glide-dir="<">
                                <svg>
                                    <use
                                        xlink:href="<?php echo base_url("assets/images/sprite.svg#icon-arrow-left2"); ?>">
                                    </use>
                                </svg>
                            </button>
                            <button class="glide__arrow glide__arrow--right" data-glide-dir=">">
                                <svg>
                                    <use
                                        xlink:href="<?php echo base_url("assets/images/sprite.svg#icon-arrow-right2"); ?>">
                                    </use>
                                </svg>
                            </button>
                        </div>
                    ...
                    <div class="title__container tabs">
                        <div class="section__titles category__titles ">
                            <div class="section__title filter-btn active" data-id="All Products">
                                <span class="dot"></span>
                                <h1 class="primary__title">Todos los Productos</h1>
                            </div>
                        </div>
                        <div class="section__titles">
                            <div class="section__title filter-btn" data-id="Trending Products">
                                <span class="dot"></span>
                                <h1 class="primary__title">Mas Comprados</h1>
                            </div>
                        </div>
                        ...
                        <div class="section__titles">
                            <div class="section__title filter-btn" data-id="Special Products">
                                <span class="dot"></span>
                                <h1 class="primary__title">Mas Baratos</h1>
                            </div>
                        </div>
                        ...
                        <div class="section__titles">
                            <div class="section__title filter-btn" data-id="Featured Products">
                                <span class="dot"></span>
                                <h1 class="primary__title">Mayor Descuento</h1>
                            </div>
                        </div>
