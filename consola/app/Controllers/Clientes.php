...
class Clientes extends BaseController
{
    ...
    {
        $this->ElModelo = new ModeloClientes();
    ...
    public function index()
    {
        ...
        if($session->get('id_usuario') == ""){
            ...
            if ($links!='NOT' || $admin=='1' ){
                ...
                /* ACA TRAEMOS A TODOS LOS Clientes*/
                $query1 = $modelo->traer_clientes();
                $datos2['result'] = $query1->getResultArray();
                echo view('header',$datos1);
                echo view('main_menu',$datos);
                echo view('admin_clientes',$datos2);
    ...
    public function agregar_rubro(){
        ...
        if($session->get('id_usuario') == ""){
            ...
            if ($links!='NOT' || $admin=='1' ){
                ...
                $menu = $modelo1->menu($session->get('id_usuario'),$session->get('admin'));
                $datos['menu'] = $menu;
                $datos3['url'] = '<script src="'.base_url("").'/assets/js/funciones/funciones_Clientes.js" ></script>';
                echo view('header',$datos1);
                echo view('main_menu',$datos);
