...
use App\Models\ModeloOfertasAprobadas;
...
class Ofertas_Aprobadas extends BaseController
{
    ...
    {
        $this->ElModelo = new ModeloOfertasAprobadas();
    ...
    public function index()
    {
        ...
        if($session->get('id_usuario') == ""){
            ...
            if ($links!='NOT' || $admin=='1' ){
                $datos1['title'] = 'Admin Ofertas Aprobadas';
                $datos1['links'] = null;
                ...
                echo view('admin_ofertas_aprobadas',$datos2);
