...
class ModeloEmpresa extends Model
{
    ...
    public function insertar_empresa($nombre, $rubro, $encargado, $telefono, $correo, $departamento, $municipio, $porcentaje, $direccion)
    {
        ...
        $permisos_admin_empresa = [77,78,79,80,81,82,83,84,85,86,87,88,89,90,94];
                                        ...
                                        <tr>
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0">
                                                ...
                                                <td>
                                                    ...
                                                    <p>Le Adjuntamos las credenciales para ingresar a su cuenta de <b>Administrador de Sucursal</b></p>
