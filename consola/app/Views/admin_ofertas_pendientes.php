                            ...
                            <?php
                                    foreach ($result as $key => $value) {
                                        ...
                                        <ul class=\"dropdown-menu dropdown-primary\">";
                                            if($permiso_editar){
                                                $filename = base_url("ofertas/editar/");
                                                $boton .="<li><a href=\"" . $filename."?id_oferta=".$id_oferta. "\"><i class=\"fa fa-pencil\"></i> Editar</a></li>";
                                            }
                                            if($permiso_borrar){
                                            ...
                                            if($permiso_rechazar){
                                                $filename = base_url("ofertas/rechazar/");
                                                $boton .= "<li><a data-toggle='modal' href='" . $filename."?id_oferta=".$id_oferta. "' data-target='#deleteModal' data-refresh='true'><i class=\"fa fa-times\"></i> Rechazar</a></li>";
                                            }
                                            if($permiso_descartar){
                                                $filename = base_url("ofertas/descartar/");
                                                $boton .= "<li><a data-toggle='modal' href='" . $filename."?id_oferta=".$id_oferta. "' data-target='#deleteModal' data-refresh='true'><i class=\"fa fa-trash\"></i> Descartar</a></li>";
                                            }
                                            if($permiso_aprobar){
                                                $filename = base_url("ofertas/aprobar/");
                                                $boton .= "<li><a data-toggle='modal' href='" . $filename."?id_oferta=".$id_oferta. "' data-target='#deleteModal' data-refresh='true'><i class=\"fa fa-check\"></i> Aprobar</a></li>";
                                            }
                                            $boton .= "	</ul>
                                                </div>
                                                </td>";
