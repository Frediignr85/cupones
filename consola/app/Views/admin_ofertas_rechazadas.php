                            ...
                            <?php
                                    foreach ($result as $key => $value) {
                                        ...
                                        <ul class=\"dropdown-menu dropdown-primary\">";
                                            ...
                                            if($ver_justificacion){
                                                $filename = base_url("ofertas/ver_justificacion/");
                                                $boton .= "<li><a data-toggle='modal' href='" . $filename."?id_oferta=".$id_oferta. "' data-target='#deleteModal' data-refresh='true'><i class=\"fa fa-eye\"></i> Ver Justificacion</a></li>";
                                            }
                                            if($permiso_aprobar){
