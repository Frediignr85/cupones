...
(function(X, L) { "object" === typeof module && module.exports ? (L["default"] = L, module.exports = X.document ? L(X) : L) : "function" === typeof define && define.amd ? define("highcharts/highcharts", function() { return L(X) }) : (X.Highcharts && X.Highcharts.error(16, !0), X.Highcharts = L(X)) })("undefined" !== typeof window ? window : this, function(X) {
    ...
    L(a, "Core/Utilities.js", [a["Core/Globals.js"]], function(a) {
        function v(b, d, g, r) {
            ...
            A(a, "displayError", { chart: g, code: b, message: M, params: r }, function() { if (d) throw Error(M);
                k.console && -1 === v.messages.indexOf(M) && console.warn(M) });
            v.messages.push(M)
        }

        function E(b, d) { var D = {};
            J(b, function(g, k) { if (G(b[k], !0) && !b.nodeType && d[k]) g = E(b[k], d[k]), Object.keys(g).length && (D[k] = g);
                else if (G(b[k]) || b[k] !== d[k]) D[k] = b[k] }); return D }
        ...
        function e(b, d) { var g;
            b || (b = {}); for (g in d) b[g] = d[g]; return b }

        function t() { for (var b = arguments, d = b.length, g = 0; g < d; g++) { var k = b[g]; if ("undefined" !== typeof k && null !== k) return k } }

        function m(b, d) { a.isMS && !a.svg && d && "undefined" !== typeof d.opacity && (d.filter = "alpha(opacity=" + 100 * d.opacity + ")");
            e(b.style, d) }
        ...
        function l(b, d, g) {
            ...
            if (b = k.getComputedStyle(b,
                    void 0)) { var r = b.getPropertyValue(d);
                t(g, "opacity" !== d) && (r = H(r)) }
            return r
        }
        ...
        function K(b, d, g) {
            function k(d, z) { var Q = b.removeEventListener || a.removeEventListenerPolyfill;
                Q && Q.call(b, d, z, !1) }

            function r(g) { var z; if (b.nodeName) { if (d) { var Q = {};
                        Q[d] = !0 } else Q = g;
                    J(Q, function(b, d) { if (g[d])
        ...
        function A(b, g, k, r) {
            k = k || {};
            if (d.createEvent && (b.dispatchEvent || b.fireEvent && b !== a)) { var D = d.createEvent("Events");
                D.initEvent(g, !0, !0);
                k = e(D, k);
                b.dispatchEvent ? b.dispatchEvent(k) : b.fireEvent(g, k) } else if (b.hcEvents) {
        ...
        var g = Array.prototype.find ? function(b, d) { return b.find(d) } : function(b, d) { var g, k = b.length; for (g = 0; g < k; g++)
        ...
        J({
            ...
            reduce: "reduce",
            some: "some"
        }, function(b, d) { a[d] = function(g) { var k;
                v(32, !1, void 0, (k = {}, k["Highcharts." + d] = "use Array." + b, k)); return Array.prototype[b].apply(g, [].slice.call(arguments, 1)) } });
        var r, F = function() { var b = Math.random().toString(36).substring(2, 9) + "-",
                d = 0; return function() { return "highcharts-" + (r ? "" : b) + d++ } }();
        ...
        return {
            ...
            destroyObjectProperties: function(b, d) {
                J(b, function(g,
                    k) { g && g !== d && g.destroy && g.destroy();
                    delete b[k] })
            },
            discardElement: function(d) { b || (b = w("div"));
                d && b.appendChild(d);
                b.innerHTML = "" },
            erase: function(b, d) { for (var g = b.length; g--;)
                    if (b[g] === d) { b.splice(g, 1); break } },
            error: v,
            extend: e,
            extendClass: function(b, d) { var g = function() {};
                g.prototype = new b;
                e(g.prototype, d); return g },
            find: g,
            fireEvent: A,
            ...
            merge: function() {
                var b, d = arguments,
                    ...
                    k = function(b,
                        d) { "object" !== typeof b && (b = {});
                        J(d, function(g, z) { "__proto__" !== z && "constructor" !== z && (!G(g, !0) || q(g) || B(g) ? b[z] = d[z] : b[z] = k(b[z] || {}, g)) }); return b };
            ...
            objectEach: J,
            offset: function(b) { var g = d.documentElement;
                b = b.parentElement || b.parentNode ? b.getBoundingClientRect() : { top: 0, left: 0, width: 0, height: 0 }; return { top: b.top + (k.pageYOffset || g.scrollTop) - (g.clientTop || 0), left: b.left + (k.pageXOffset || g.scrollLeft) - (g.clientLeft || 0), width: b.width, height: b.height } },
            ...
            stableSort: function(b, d) { var g = b.length,
                    k, r; for (r = 0; r < g; r++) b[r].safeI = r;
                b.sort(function(b, g) { k = d(b, g); return 0 === k ? b.safeI - g.safeI : k }); for (r = 0; r < g; r++) delete b[r].safeI },
            syncTimeout: function(b, d, g) { if (0 < d) return setTimeout(b, d, g);
                b.call(0, g); return -1 },
    ...
    L(a, "Core/Color/Color.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, u) {
        ...
        u = function() {
            ...
            u.prototype.get = function(a) {
                var B = this.input,
                    q = this.rgba;
                if ("undefined" !== typeof this.stops) { var h = H(B);
                    h.stops = [].concat(h.stops);
                    this.stops.forEach(function(f, c) { h.stops[c] = [h.stops[c][0], f.get(a)] }) } else h =
                    q && v(q[0]) ? "rgb" === a || !a && 1 === q[3] ? "rgb(" + q[0] + "," + q[1] + "," + q[2] + ")" : "a" === a ? q[3] : "rgba(" + q.join(",") + ")" : B;
                return h
            };
            u.prototype.brighten = function(a) { var B, q = this.rgba; if (this.stops) this.stops.forEach(function(h) { h.brighten(a) });
                else if (v(a) && 0 !== a)
                    for (B = 0; 3 > B; B++) q[B] += x(255 * a), 0 > q[B] && (q[B] = 0), 255 < q[B] && (q[B] = 255); return this };
    ...
    L(a, "Core/Time.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, u) {
        ...
        u = function() {
            function w(c) { this.options = {};
                this.variableTimezone = this.useUTC = !1;
                this.Date = v.Date;
                this.getTimezoneOffset = this.timezoneOffsetFunction();
                this.update(c) }
            w.prototype.get = function(c, l) { if (this.variableTimezone || this.timezoneOffset) { var e = l.getTime(),
                        n = e - this.getTimezoneOffset(l);
                    l.setTime(n);
                    c = l["getUTC" + c]();
                    l.setTime(e); return c } return this.useUTC ? l["getUTC" + c]() : l["get" + c]() };
            w.prototype.set = function(c, l, e) {
                if (this.variableTimezone ||
                    this.timezoneOffset) { if ("Milliseconds" === c || "Seconds" === c || "Minutes" === c && 0 === this.getTimezoneOffset(l) % 36E5) return l["setUTC" + c](e); var n = this.getTimezoneOffset(l);
                    n = l.getTime() - n;
                    l.setTime(n);
                    l["setUTC" + c](e);
                    c = this.getTimezoneOffset(l);
                    n = l.getTime() + c; return l.setTime(n) }
            ...
            w.prototype.makeTime = function(c, l, e, h, t, p) { if (this.useUTC) { var d = this.Date.UTC.apply(0, arguments); var k = this.getTimezoneOffset(d);
                    d += k; var b = this.getTimezoneOffset(d);
                    k !== b ? d += b - k : k - 36E5 !== this.getTimezoneOffset(d - 36E5) || m || (d -= 36E5) } else d = (new this.Date(c, l, f(e, 1), f(h, 0), f(t, 0), f(p, 0))).getTime(); return d };
            w.prototype.timezoneOffsetFunction = function() {
                ...
                if (l.timezone) { if (e) return function(c) { return 6E4 * -e.tz(c, l.timezone).utcOffset() };
                    x(25) }
    ...
    L(a, "Core/Animation/Fx.js", [a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, u, E) {
        ...
        return function() {
            ...
            a.prototype.update = function() { var a = this.elem,
                    h = this.prop,
                    f = this.now,
                    c = this.options.step; if (this[h + "Setter"]) this[h + "Setter"]();
            ...
            a.prototype.step = function(a) {
                ...
                if (c.attr && !c.element) a = !1;
                    ...
                    h >= t + this.startTime) { this.now = this.end;
                    this.pos = 1;
                    this.update(); var w = m[this.prop] = !0;
                    G(m, function(c) {!0 !== c && (w = !1) });
                    w && e && e.call(c);
                    a = !1 } else this.pos = f.easing((h - this.startTime) / t), this.now = this.start + (this.end - this.start) * this.pos, this.update(), a = !0;
                return a
            };
            a.prototype.initPath = function(a, h, f) {
                function c(c, l) { for (; c.length < K;) { var d = c[0],
                            k = l[K - c.length];
                        k && "M" === d[0] && (c[0] = "C" === k[0] ? ["C", d[1], d[2], d[1], d[2], d[1], d[2]] : ["L", d[1], d[2]]);
                        c.unshift(d);
                        w && (d = c.pop(), c.push(c[c.length - 1], d)) } }

                function e(c, l) { for (; c.length < K;)
                        if (l = c[Math.floor(c.length / n) - 1].slice(), "C" === l[0] && (l[1] = l[5], l[2] = l[6]), w) { var d = c[Math.floor(c.length / n)].slice();
                            c.splice(c.length / 2, 0, l, d) } else c.push(l) }
                var t = a.startX,
                    m = a.endX;
                f = f.slice();
                var w = a.isArea,
                ...
                if (h.length && y(l)) { var K = f.length + l * n;
        ...
        return {
            ...
            getDeferredAnimation: function(c, a, f) {
                var e = v(a),
                    n = 0,
                    l = 0;
                (f ? [f] : c.series).forEach(function(c) { c = v(c.options.animation);
    ...
    L(a, "Core/Renderer/HTML/AST.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, u) {
        ...
        u = function() {
            ...
            c.filterUserAttributes =
                function(e) { q(e, function(a, f) { var h = !0; - 1 === c.allowedAttributes.indexOf(f) && (h = !1); - 1 !== ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(f) && (h = B(a) && c.allowedReferences.some(function(c) { return 0 === a.indexOf(c) }));
                        h || (G("Highcharts warning: Invalid attribute '" + f + "' in config"), delete e[f]) }); return e };
            c.setElementHTML = function(e, a) { e.innerHTML = "";
            ...
            c.prototype.addToDOM = function(e) {
                function f(e, t) {
                    ...
                    h(e).forEach(function(l) {
                        ...
                        if (e)
                            if ("#text" === e) var m = h;
                            else if (-1 !== c.allowedTags.indexOf(e)) { e = a.doc.createElementNS("svg" === e ? v : t.namespaceURI || v, e); var p = l.attributes || {};
                            q(l, function(d, k) { "tagName" !== k && "attributes" !== k && "children" !== k && "textContent" !== k && (p[k] = d) });
                            H(e, c.filterUserAttributes(p));
                            h && e.appendChild(h);
                            f(l.children || [], e);
                            m = e } else G("Highcharts warning: Invalid tagName '" + e + "' in config");
                        m && t.appendChild(m);
                        n = m
                    });
                    return n
            ...
            c.prototype.parseMarkup = function(c) {
                ...
                if (f) c =
                    ...
                    a.innerHTML = c;
                    c = { body: a } }
                var h = function(c, l) { var e = c.nodeName.toLowerCase(),
                        a = { tagName: e }; if ("#text" === e) { e = c.textContent || ""; if (/^[\s]*$/.test(e)) return;
                        a.textContent = e } if (e = c.attributes) { var f = {};
                        [].forEach.call(e, function(d) { f[d.name] = d.value });
                        a.attributes = f } if (c.childNodes.length) { var p = [];
    ...
    L(a, "Core/FormatUtilities.js", [a["Core/DefaultOptions.js"], a["Core/Utilities.js"]], function(a, u) {
        ...
        return {
            ...
            format: function(a, f, c) { var e = "{",
                    h = !1,
                    m = /f$/,
                    w = /\.([0-9])/,
                    n = H.lang,
                    l = c && c.time || x;
                c = c && c.numberFormatter || v; for (var J = []; a;) { var K = a.indexOf(e); if (-1 === K) break; var A = a.slice(0, K); if (h) { A = A.split(":");
                        e = y(A.shift() || "", f); if (A.length && "number" === typeof e)
                            if (A = A.join(":"), m.test(A)) { var p = parseInt((A.match(w) || ["", "-1"])[1], 10);
                                null !== e && (e = c(e, p, n.decimalPoint, -1 < A.indexOf(",") ? n.thousandsSep : "")) } else e = l.dateFormat(A, e);
                        J.push(e) } else J.push(A);
                    a = a.slice(K + 1);
                    e = (h = !h) ? "}" : "{" }
    ...
    L(a, "Core/Renderer/SVG/SVGElement.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Renderer/HTML/AST.js"], a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/Utilities.js"]], function(a, u, E, H, x, y) {
        var v = a.animate,
            ...
            S = y.uniqueKey;
        a = function() {
            function a() { this.element = void 0;
                this.onEvents = {};
                this.opacity = 1;
            ...
            a.prototype.add = function(b) { var d = this.renderer,
                    g = this.element;
                b && (this.parentGroup = b);
                this.parentInverted = b && b.inverted; "undefined" !== typeof this.textStr && "text" === this.element.nodeName && d.buildText(this);
                this.added = !0; if (!b || b.handleZ || this.zIndex) var k = this.zIndexSetter();
                k || (b ? b.element : d.box).appendChild(g); if (this.onAdd) this.onAdd(); return this };
            ...
            a.prototype.animate = function(b, d, g) { var k = this,
                    z = B(M(d, this.renderer.globalAnimation, !0));
                d = z.defer;
                M(f.hidden, f.msHidden, f.webkitHidden, !1) && (z.duration = 0);
                0 !== z.duration ? (g && (z.complete = g), O(function() { k.element && v(k, b, z) }, d)) : (this.attr(b, void 0, g), D(b, function(b, d) { z.step && z.step.call(this, b, { prop: d, pos: 1, elem: this }) }, this)); return this };
            a.prototype.applyTextOutline = function(b) {
                ...
                if ((g = g[0]) && "none" !== g && H.svg) {
                    ...
                    c.textContent = "\u200b";
                    ["x", "y"].forEach(function(b) { var g = d.getAttribute(b);
            ...
            a.prototype.attr = function(b, d, g, k) {
                var z = this.element,
                    ...
                    c, I = this,
                    r, a;
                if ("string" === typeof b && "undefined" !== typeof d) { var l = b;
                    b = {};
                    b[l] = d }
            ...
            a.prototype.css = function(b) {
                ...
                if (a) {
                    ...
                    if (k.namespaceURI === this.SVG_NS) { var l = function(b, d) { return "-" + d.toLowerCase() };
                        D(b, function(b, d) {-1 === c.indexOf(d) && (r += d.replace(/([A-Z])/g, l) + ":" + b + ";") });
                        r && n(k, "style", r) } else J(k, b);
            ...
            a.prototype.destroy = function() {
                ...
                q(b);
                if (b.clipPath && k) { var r = b.clipPath;
                ...
                if (b.stops) { for (k = 0; k < b.stops.length; k++) b.stops[k].destroy();
                    b.stops.length = 0;
                    b.stops = void 0 }
                b.safeRemoveChild(d);
                ...
                D(b, function(d, g) { b[g] && b[g].parentGroup === b && b[g].destroy && b[g].destroy();
                    delete b[g] })
            };
            ...
            a.prototype.fadeOut = function(b) { var d = this;
            ...
            a.prototype.getBBox = function(d, g) {
                ...
                var P =
                    ...
                    f;
                if (K(l)) { var n = l.toString(); - 1 === n.indexOf("<") && (n = n.replace(/[0-9]/g, "0"));
                    n += ["", g, P, this.textWidth, r && r.textOverflow, r && r.fontWeight].join() }
                n && !d && (f = e[n]);
                if (!f) {
                    if (F || k.forExport) {
                        try { var D = this.fakeTS && function(b) { var d = c.querySelector(".highcharts-text-outline");
                                d && J(d, { display: b }) };
                            b(D) && D("none");
                    ...
                    if (n && 0 < f.height) { for (; 250 < I.length;) delete e[I.shift()];
                        e[n] || I.push(n);
                        e[n] = f }
                }
                return f
            ...
            a.prototype.init = function(b, g) { this.element = "span" === g ? l(g) : f.createElementNS(this.SVG_NS, g);
                this.renderer = b;
                d(this, "afterInit") };
            a.prototype.invert = function(b) { this.inverted = b;
            ...
            a.prototype.opacitySetter = function(b, d, g) { this.opacity = b = Number(Number(b).toFixed(3));
                g.setAttribute(d, b) };
            a.prototype.removeClass = function(b) { return this.attr("class", ("" + this.attr("class")).replace(r(b) ? new RegExp("(^| )" + b + "( |$)") : b, " ").replace(/ +/g, " ").trim()) };
            a.prototype.removeTextOutline = function() { var b = this.element.querySelector("tspan.highcharts-text-outline");
                b && this.safeRemoveChild(b) };
            a.prototype.safeRemoveChild = function(b) { var d = b.parentNode;
                d && d.removeChild(b) };
            a.prototype.setRadialReference = function(b) { var d = this.element.gradient && this.renderer.gradients[this.element.gradient];
                this.element.radialReference = b;
                d && d.radAttr && d.animate(this.renderer.getRadialAttr(b, d.radAttr)); return this };
            ...
            a.prototype.strokeWidth = function() { if (!this.renderer.styledMode) return this["stroke-width"] || 0; var b = this.getStyle("stroke-width"),
                    d = 0; if (b.indexOf("px") === b.length - 2) d = C(b);
                else if ("" !== b) { var g = f.createElementNS(t, "rect");
                    n(g, { width: b, "stroke-width": 0 });
                    this.element.parentNode.appendChild(g);
                    d = g.getBBox().width;
                    g.parentNode.removeChild(g) } return d };
            a.prototype.symbolAttr =
                function(b) { var d = this; "x y r start end width height innerR anchorX anchorY clockwise".split(" ").forEach(function(g) { d[g] = M(b[g], d[g]) });
            ...
            a.prototype.toFront = function() { var b = this.element;
                b.parentNode.appendChild(b); return this };
            a.prototype.translate = function(b, d) { return this.attr({ translateX: b, translateY: d }) };
            a.prototype.updateShadows = function(b, d, g) { var k = this.shadows; if (k)
            ...
            a.prototype.visibilitySetter = function(b, d, g) { "inherit" === b ? g.removeAttribute(d) : this[d] !== b && g.setAttribute(d, b);
                this[d] = b };
            ...
            a.prototype.zIndexSetter = function(b, d) {
                ...
                if (l) {
                    ...
                    d = c.childNodes; for (e = d.length - 1; 0 <= e && !a; e--) { k = d[e];
                        l = k.getAttribute("data-z-index"); var f = !K(l); if (k !== r)
        ...
        a.prototype.matrixSetter = a.prototype.rotationOriginXSetter =
            a.prototype.rotationOriginYSetter = a.prototype.rotationSetter = a.prototype.scaleXSetter = a.prototype.scaleYSetter = a.prototype.translateXSetter = a.prototype.translateYSetter = a.prototype.verticalAlignSetter = function(b, d) { this[d] = b;
                this.doTransform = !0 };
        "";
        return a
    });
    ...
    L(a, "Core/Renderer/SVG/SVGLabel.js", [a["Core/Renderer/SVG/SVGElement.js"], a["Core/Utilities.js"]], function(a, u) {
        var v = this && this.__extends || function() {
                var a = function(f, c) { a = Object.setPrototypeOf || { __proto__: [] }
                    instanceof Array && function(c, a) { c.__proto__ = a } || function(c, a) { for (var e in a) a.hasOwnProperty(e) && (c[e] = a[e]) }; return a(f, c) };
                return function(f, c) {
        ...
        return function(h) {
            ...
            f.prototype.fillSetter = function(c, a) { c && (this.needsBox = !0);
                this.fill = c;
                this.boxAttr(a, c) };
            f.prototype.getBBox = function() { this.textStr && 0 === this.bBox.width && 0 === this.bBox.height && this.updateBoxSize(); var c = this.padding,
                    a = B(this.paddingLeft, c); return { width: this.width, height: this.height, x: this.bBox.x - a, y: this.bBox.y - c } };
            ...
            f.prototype.onAdd = function() { var c = this.textStr;
                this.text.add(this);
            ...
            f.prototype.strokeSetter = function(c, a) { this.stroke = c;
                this.boxAttr(a, c) };
            f.prototype["stroke-widthSetter"] = function(a, e) { a && (this.needsBox = !0);
                this["stroke-width"] = a;
                this.boxAttr(e, a) };
            f.prototype["text-alignSetter"] = function(a) { this.textAlign = a };
            f.prototype.textSetter = function(a) { "undefined" !== typeof a && this.text.attr({ text: a });
            ...
            f.prototype.getPaddedWidth = function() { var a = this.padding,
                    e = B(this.paddingLeft, a);
                a = B(this.paddingRight, a); return (this.widthSetting || this.bBox.width || 0) + e + a };
            f.prototype.xSetter =
                function(a) { this.x = a;
                    this.alignFactor && (a -= this.alignFactor * this.getPaddedWidth(), this["forceAnimate:x"] = !0);
                    this.xSetting = Math.round(a);
                    this.attr("translateX", this.xSetting) };
            f.prototype.ySetter = function(a) { this.ySetting = this.y = Math.round(a);
    ...
    L(a, "Core/Renderer/SVG/Symbols.js", [a["Core/Utilities.js"]], function(a) {
        function v(a, q, h, f, c) { var e = []; if (c) { var t = c.start || 0,
                    m = G(c.r, h);
                h = G(c.r, f || h); var w = (c.end || 0) - .001;
                f = c.innerR; var n = G(c.open, .001 > Math.abs((c.end || 0) - t - 2 * Math.PI)),
                    l = Math.cos(t),
                    J = Math.sin(t),
                    K = Math.cos(w),
                    A = Math.sin(w);
        ...
        function E(a,
            q, h, f, c) { return c && c.r ? H(a, q, h, f, c) : [
                ["M", a, q],
                ["L", a + h, q],
                ["L", a + h, q + f],
                ["L", a, q + f],
        ...
        function H(a, q, h, f, c) { c = c && c.r || 0; return [
                ["M", a + c, q],
                ["L", a + h - c, q],
        ...
        return {
            ...
            diamond: function(a, q, h, f) { return [
                    ["M", a + h / 2, q],
                    ["L", a + h, q + f / 2],
                    ["L", a + h / 2, q + f],
                    ["L", a, q + f / 2],
            ...
            roundedRect: H,
            square: E,
            triangle: function(a, q, h, f) { return [
                    ["M", a + h / 2, q],
                    ["L", a + h, q + f],
                    ["L", a, q + f],
                    ["Z"]
                ] },
            "triangle-down": function(a, q, h, f) { return [
                    ["M", a, q],
                    ["L", a + h, q],
                    ["L", a + h / 2, q + f],
                    ["Z"]
    ...
    L(a, "Core/Renderer/SVG/TextBuilder.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function(a,
        ...
        return function() {
                ...
                if (h) {
                    var m = function(f, l) {
                            ...
                            if (a.ellipsis) n && a.truncate(f, n, void 0, 0, Math.max(0, h - parseInt(a.fontSize || 12, 10)), function(b, d) { return b.substring(0, d) + "\u2026" });
                                ...
                                n.forEach(function(b) { l.insertBefore(v.createTextNode(b), f);
            ...
            h.prototype.getLineHeight = function(a) { var c;
                a = a.nodeType === Node.TEXT_NODE ? a.parentElement : a;
                this.renderer.styledMode || (c = a && /(px|em)$/.test(a.style.fontSize) ? a.style.fontSize : this.fontSize || this.renderer.style.fontSize || 12); return this.textLineHeight ? parseInt(this.textLineHeight.toString(), 10) : this.renderer.fontMetrics(c, a || this.svgElement.element).h };
            ...
            h.prototype.truncate = function(a, c, e, h, m, w) {
                ...
                if (h + g > m) { for (; A <= p;) d = Math.ceil((A + p) / 2), e && (k = w(e, d)), g = b(d, k && k.length - 1), A === p ? A = p + 1 : g > m ? p = d - 1 : A = d;
    ...
    L(a, "Core/Renderer/SVG/SVGRenderer.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/Renderer/RendererRegistry.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Renderer/SVG/SVGLabel.js"], a["Core/Renderer/SVG/Symbols.js"], a["Core/Renderer/SVG/TextBuilder.js"], a["Core/Utilities.js"]], function(a, u, E, H, x, y, G, B, q, h) {
        var f = E.charts,
            ...
            ba;
        E = function() {
            function z(b, d, g, a, k, r, c) { this.width = this.url = this.style = this.isSVG = this.imgCount = this.height = this.gradients = this.globalAnimation = this.defs = this.chartIndex = this.cacheKeys = this.cache = this.boxWrapper = this.box = this.alignedObjects = void 0;
            ...
            z.prototype.init = function(b, d, g, a, r, c, z) {
                ...
                this.setSize(d, g, !1);
                var I;
                t && b.getBoundingClientRect && (d = function() { k(b, { left: 0, top: 0 });
                    I = b.getBoundingClientRect();
                    k(b, { left: Math.ceil(I.left) - I.left + "px", top: Math.ceil(I.top) - I.top + "px" }) }, d(), this.unSubPixelFix = A(K, "resize", d))
            };
            ...
            z.prototype.createElement = function(b) { var d = new this.Element;
                d.init(this, b); return d };
            ...
            z.prototype.buildText = function(b) {
                (new q(b)).buildSVG() };
            z.prototype.getContrast = function(b) { b = u.parse(b).rgba;
                b[0] *= 1;
                b[1] *= 1.2;
            ...
            z.prototype.crispLine = function(d, g, a) { void 0 === a && (a = "round"); var k = d[0],
                    r = d[1];
                b(k[1]) && k[1] === r[1] && (k[1] = r[1] = Math[a](k[1]) - g % 2 / 2);
                b(k[2]) && k[2] === r[2] && (k[2] = r[2] = Math[a](k[2]) + g % 2 / 2); return d };
            z.prototype.path = function(b) { var d = this.styledMode ? {} : { fill: "none" };
                F(b) ? d.d = b : M(b) && r(d, b); return this.createElement("path").attr(d) };
            z.prototype.circle = function(b, d, g) { b = M(b) ? b : "undefined" === typeof b ? {} : { x: b, y: d, r: g };
                d = this.createElement("circle");
                d.xSetter = d.ySetter = function(b, d, g) { g.setAttribute("c" + d, b) }; return d.attr(b) };
            z.prototype.arc = function(b, d, g, a, k, r) { M(b) ? (a = b, d = a.y, g = a.r, b = a.x) : a = { innerR: a, start: k, end: r };
            ...
            z.prototype.rect = function(b, d, g, a, k, r) {
                ...
                k && (b.r = k);
                c.rSetter = function(b, d, g) { c.r = b;
                    p(g, { rx: b, ry: b }) };
                c.rGetter = function() { return c.r || 0 };
                return c.attr(b)
            };
            z.prototype.setSize = function(b, d, g) { this.width = b;
                this.height = d;
            ...
            z.prototype.symbol = function(g, a, c, z, l, F) {
                var I = this,
                    ...
                    n = D && this.symbols[D],
                    C;
                if (n) { "number" === typeof a && (C = n.call(this.symbols, Math.round(a || 0), Math.round(c || 0), z || 0, l || 0, F)); var p = this.path(C);
                    ...
                    ["width", "height"].forEach(function(d) { w[d + "Setter"] = function(d, g) { var a = this["img" + g];
                            this[g] = d;
                    ...
                    b(a) && w.attr({ x: a, y: c });
                    w.isImg = !0;
                    b(w.imgwidth) && b(w.imgheight) ? m(w) : (w.attr({ width: 0, height: 0 }), d("img", { onload: function() { var b = f[I.chartIndex];
                            ...
                            I.imgCount--; if (!I.imgCount && b && !b.hasLoaded) b.onload() }, src: N }), this.imgCount++)
                }
                return p
            };
            z.prototype.clipRect =
                function(b, d, g, a) { var k = Y() + "-",
            ...
            z.prototype.fontMetrics = function(b, d) { b = !this.styledMode && /px/.test(b) || !K.getComputedStyle ? b || d && d.style && d.style.fontSize || this.style && this.style.fontSize : d && y.prototype.getStyle.call(d, "font-size");
                b = /px/.test(b) ? W(b) : 12;
                d = 24 > b ? b + 3 : Math.round(1.2 * b); return { h: d, b: Math.round(.8 * d), f: b } };
            z.prototype.rotCorr = function(b, d, g) { var a = b;
                d && g && (a = Math.max(a * Math.cos(d * c), 4)); return { x: -b / 3 * Math.sin(d * c), y: a } };
    ...
    L(a, "Core/Renderer/HTML/HTMLElement.js", [a["Core/Globals.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Utilities.js"]], function(a, u, E) {
        var v = this && this.__extends || function() {
                var a = function(c, e) { a = Object.setPrototypeOf || { __proto__: [] }
                    instanceof Array && function(a, c) { a.__proto__ = c } || function(a, c) { for (var l in c) c.hasOwnProperty(l) && (a[l] = c[l]) }; return a(c, e) };
                return function(c,
                    e) {
        ...
        return function(a) {
            ...
            v(m, a);
            m.compose = function(a) { a = a.prototype; var c = m.prototype;
            ...
            m.prototype.getSpanCorrection = function(a, c, l) { this.xCorr = -a * l;
                this.yCorr = -c };
            m.prototype.htmlCss = function(a) { var e = "SPAN" === this.element.tagName && a && "width" in a,
                    l = c(e && a.width, void 0); if (e) { delete a.width;
                    this.textWidth = l; var h = !0 }
                a && "ellipsis" === a.textOverflow && (a.whiteSpace = "nowrap", a.overflow = "hidden");
                this.styles = f(this.styles, a);
                q(this.element, a);
                h && this.htmlUpdateTransform(); return this };
    ...
    L(a, "Core/Renderer/HTML/HTMLRenderer.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Renderer/SVG/SVGRenderer.js"], a["Core/Utilities.js"]], function(a, u, E, H) {
        ...
        return function(h) {
            ...
            f.prototype.html = function(c, e, f) {
                var h = this.createElement("span"),
                    ...
                    t = function(a, c) {
                        ["opacity", "visibility"].forEach(function(l) {
                            a[l +
                                "Setter"] = function(d, k, b) { var g = a.div ? a.div.style : c;
                ...
                h.xSetter = h.ySetter = h.alignSetter = h.rotationSetter = function(a, c) { "align" === c ? h.alignValue = h.textAlign = a : h[c] = a;
                    h.doTransform = !0 };
                    ...
                    if (this.parentGroup = a) {
                        ...
                        if (!d) {
                            ...
                            l.reverse().forEach(function(a) {
                                function b(b, d) { a[d] = b; "translateX" === d ? e.left = b + "px" : e.top = b + "px";
                                    a.doTransform = !0 }
                                ...
                                var e = d.style;
                                B(a, { classSetter: function(b) { return function(d) { this.element.setAttribute("class", d);
                                            b.className = d } }(d), on: function() { l[0].div && h.on.apply({ element: l[0].div, onEvents: h.onEvents }, arguments); return a }, translateXSetter: b, translateYSetter: b });
                                a.addedSetters || t(a)
                            })
                        }
                    } else d = c;
    ...
    L(a, "Core/Foundation.js", [a["Core/Utilities.js"]], function(a) { var v = a.addEvent,
            E = a.isFunction,
            H = a.objectEach,
            x = a.removeEvent; return { registerEventOptions: function(a, u) { a.eventOptions = a.eventOptions || {};
    ...
    L(a, "Core/Axis/Tick.js", [a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, u, E) {
        ...
        u = function() {
            ...
            m.prototype.getPosition = function(a, c, l, e) { var f = this.axis,
                    n = f.chart,
                ...
                a.y = x(a.y, -1E5, 1E5);
                h(this, "afterGetPosition", { pos: a }); return a };
            ...
            m.prototype.getMarkPath = function(a, c, l, e, f, h) { return h.crispLine([
                    ["M", a, c],
                    ["L", a + (f ? 0 : -l), c + (f ? l : 0)]
                ], e) };
            ...
            m.prototype.render = function(a, c, l) { var e = this.axis,
                    f = e.horiz,
                    n = this.pos,
            ...
            m.prototype.replaceMovedLabel = function() { var a = this.label,
                    c = this.axis,
                    e = c.reversed; if (a && !this.isNew) { var f = c.horiz ? e ? c.left : c.width + c.left : a.xy.x;
    ...
    L(a, "Core/Axis/Axis.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Color/Color.js"], a["Core/Color/Palette.js"], a["Core/DefaultOptions.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Core/Utilities.js"], a["Core/Axis/AxisDefaults.js"], a["Core/Axis/Tick.js"]], function(a, u, E, H, x, y, G, B, q) {
        ...
        a = function() {
                ...
                d(this, "getSeriesExtremes", null, function() {
                    ...
                    b.series.forEach(function(d) {
                        if (d.visible || !a.options.chart.ignoreHiddenSeries) {
                            ...
                            if (b.isXAxis) { if (c = d.xData, c.length) { c = b.logarithmic ? c.filter(b.validatePositiveValue) : c;
                                    k = d.getXExtremes(c); var e = k.min; var z = k.max;
                                    g(e) || e instanceof Date || (c = c.filter(g), k = d.getXExtremes(c), e = k.min, z = k.max);
                                    c.length && (b.dataMin = Math.min(C(b.dataMin, e), e), b.dataMax = Math.max(C(b.dataMax, z), z)) } } else if (d = d.applyExtremes(), g(d.dataMin) && (e = d.dataMin, b.dataMin = Math.min(C(b.dataMin, e), e)), g(d.dataMax) && (z = d.dataMax, b.dataMax = Math.max(C(b.dataMax,
            ...
            a.prototype.getPlotLinePath = function(b) {
                ...
                d(this, "getPlotLinePath", b, function(b) { p = C(p, c.translate(f, null, null, l));
                    p = w(p, -1E5, 1E5);
                    n = t = Math.round(p + D);
            ...
            a.prototype.getLinearTickPositions = function(b, a,
                d) { var g = n(Math.floor(a / b) * b);
                d = n(Math.ceil(d / b) * b); var c = [],
                    k;
                n(g + b) === g && (k = 20); if (this.single) return [a]; for (a = g; a <= d;) { c.push(a);
                    a = n(a + b, k); if (a === r) break; var r = a } return c };
            ...
            a.prototype.getMinorTickPositions = function() {
                ...
                var k = g - c,
                    r = [];
                if (k && k / d < this.len / 3) { var e = this.logarithmic; if (e) this.paddedTicks.forEach(function(b, a, g) { a && r.push.apply(r, e.getLogTickPositions(d, g[a - 1], g[a], !0)) });
            ...
            a.prototype.adjustForMinRange = function() {
                var b = this.options,
                    ...
                    c = 0,
                    k, r, e, f;
                this.isXAxis && "undefined" === typeof this.minRange && !a && (l(b.min) || l(b.max) ? this.minRange = null : (this.series.forEach(function(b) { e = b.xData;
                    f = b.xIncrement ? 1 : e.length - 1; if (1 < e.length)
                        for (k = f; 0 < k; k--)
                            if (r = e[k] - e[k - 1], !c || r < c) c = r }), this.minRange = Math.min(5 * c, this.dataMax - this.dataMin)));
            ...
            a.prototype.getClosest = function() { var b;
                this.categories ? b = 1 : this.series.forEach(function(a) { var d = a.closestPointRange,
                        g = a.visible || !a.chart.options.chart.ignoreHiddenSeries;!a.noSharedTooltip && l(d) && g && (b = l(b) ? Math.min(b, d) : d) }); return b };
            ...
            a.prototype.trimTicks = function(b, a, g) { var c = b[0],
                    k = b[b.length - 1],
                    e = !this.isOrdinal && this.minPointOffset || 0;
                d(this, "trimTicks"); if (!this.isLinked) { if (a && -Infinity !== c) this.min = c;
                    else
                        for (; this.min - e > b[0];) b.shift(); if (g) this.max = k;
                    else
            ...
            a.prototype.alignToOthers = function() {
                ...
                !1 !== this.chart.options.chart.alignTicks &&
                    a.alignTicks && !1 !== a.startOnTick && !1 !== a.endOnTick && !this.logarithmic && this.chart[this.coll].forEach(function(a) { var g = a.options;
            ...
            a.prototype.adjustTickAmount = function() {
                ...
                if (this.hasData() && g(this.min) && g(this.max)) {
                    ...
                    if (l(k)) { for (a = b = d.length; a--;)(3 === k && 1 === a % 2 || 2 >= k && 0 < a && a < b - 1) && d.splice(a, 1);
            ...
            a.prototype.setScale = function() {
                var b = !1,
                    a = !1;
                this.series.forEach(function(d) { b = b || d.isDirtyData || d.isDirty;
            ...
            a.prototype.setExtremes = function(b, a, g, c, k) {
                ...
                k = p(k, { min: b, max: a });
                d(e, "setExtremes", k, function() { e.userMin = b;
                    e.userMax = a;
                    e.eventArgs = k;
                    g && r.redraw(c) })
            };
            ...
            a.prototype.getThreshold = function(b) { var a = this.logarithmic,
                    d = a ? a.lin2log(this.min) : this.min;
                a = a ? a.lin2log(this.max) : this.max;
                null === b || -Infinity === b ? b = d : Infinity === b ? b = a : d > b ? b = d : a < b && (b = a); return this.translate(b, 0, 1, 0, 1) };
            a.prototype.autoLabelAlign =
                function(b) { var a = (C(b, 0) - 90 * this.side + 720) % 360;
                    b = { align: "center" };
                    d(this, "autoLabelAlign", b, function(b) { 15 < a && 165 > a ? b.align = "right" : 195 < a && 345 > a && (b.align = "left") }); return b.align };
            a.prototype.tickSize = function(b) { var a = this.options,
                    g = C(a["tick" === b ? "tickWidth" : "minorTickWidth"], "tick" === b && this.isXAxis && !this.categories ? 1 : 0),
                    c = a["tick" === b ? "tickLength" : "minorTickLength"]; if (g && c) { "inside" === a[b + "Position"] && (c = -c); var k = [c, g] }
                b = { tickSize: k };
                d(this, "afterTickSize", b); return b.tickSize };
            ...
            a.prototype.unsquish = function() {
                ...
                if (a) { if (!b.staggerLines && !b.step)
                        if (g(e)) var M = [e];
                        else k < b.autoRotationLimit && (M = b.autoRotation);
                    M && M.forEach(function(b) { if (b === e || b && -90 <= b && 90 >= b) { D = f(Math.abs(r.h / Math.sin(c * b))); var a = D + Math.abs(b / 360);
                            a < p && (p = a, F = b, h = D) } }) } else b.step || (h = f(r.h));
                this.autoRotation = M;
            ...
            a.prototype.generateTick = function(b) { var a = this.ticks;
            ...
            a.prototype.getOffset =
                function() {
                    ...
                    D || a.isLinked ? (e.forEach(function(b) { a.generateTick(b) }), a.renderUnsquish(), a.reserveSpaceDefault = 0 === h || 2 === h || { 1: "left", 3: "right" }[h] === a.labelAlign, C(n.reserveSpace, "center" === a.labelAlign ? !0 : null, a.reserveSpaceDefault) && e.forEach(function(b) { A = Math.max(r[b].getLabelSize(), A) }), a.staggerLines && (A *= a.staggerLines), a.labelOffset = A * (a.opposite ? -1 :
                        1)) : M(r, function(b, a) { b.destroy();
                        delete r[a] });
                    if (p && p.text && !1 !== p.enabled && (a.addTitle(O), O && !1 !== p.reserveSpace)) { a.titleOffset = Z = a.axisTitle.getBBox()[f ? "height" : "width"]; var v = p.offset;
            ...
            a.prototype.drawCrosshair = function(b, a) {
                ...
                if (g && !1 !== (l(a) || !c)) {
                    ...
                    if (l(e)) { var f = { value: a && (this.isXAxis ? a.x : C(a.stackY, a.y)), translatedValue: e };
            ...
            a.prototype.hideCrosshair = function() { this.cross && this.cross.hide();
            ...
            a.prototype.update = function(b, a) { var d = this.chart;
    ...
    L(a, "Core/Axis/DateTimeAxis.js", [a["Core/Axis/Axis.js"], a["Core/Utilities.js"]], function(a, u) {
        var v = u.addEvent,
            ...
            G = function() {
                ...
                a.prototype.normalizeTimeTickInterval = function(a, h) { var f = h || [
                    ...
                    h = f[f.length - 1]; var c = y[h[0]],
                        e = h[1],
                        t; for (t = 0; t < f.length && !(h = f[t], c = y[h[0]], e = h[1], f[t + 1] && a <= (c * e[e.length - 1] + y[f[t + 1][0]]) / 2); t++);
                    c === y.year && a < 5 * c && (e = [1, 2, 5]);
                    a = x(a / c, e, "year" === h[0] ? Math.max(H(a / c), 1) : 1); return { unitRange: c, count: a, unitName: h[0] } };
                return a
            }();
        u = function() {
            function a() {}
            a.compose = function(a) { a.keepProps.push("dateTime");
    ...
    L(a, "Core/Axis/LogarithmicAxis.js", [a["Core/Axis/Axis.js"], a["Core/Utilities.js"]], function(a, u) {
        ...
        u = function() {
            function a() {}
            a.compose = function(a) { a.keepProps.push("logarithmic");
                ...
                v(a, "afterInit", function() { var a = this.logarithmic;
    ...
    L(a, "Core/Axis/PlotLineOrBand.js", [a["Core/Axis/Axis.js"], a["Core/Color/Palette.js"], a["Core/Utilities.js"]], function(a,
        ...
        var v = E.arrayMax,
            ...
            m = function() {
                ...
                a.prototype.destroy = function() { B(this.axis.plotLinesAndBands, this);
                    delete this.axis;
                    G(this) };
                return a
            }();
        q(a.prototype, {
            getPlotBandPath: function(a, c, e) {
                ...
                if (e && l) { if (a) { var d = e.toString() === l.toString();
                        p = 0 } for (a = 0; a < e.length; a += 2) { c = e[a]; var k = e[a + 1],
                            b = l[a],
                            g = l[a + 1]; "M" !== c[0] && "L" !== c[0] || "M" !== k[0] && "L" !== k[0] || "M" !== b[0] && "L" !== b[0] || "M" !== g[0] && "L" !== g[0] || (m && b[1] === c[1] ? (b[1] += p, g[1] += p) : m || b[2] !== c[2] || (b[2] += p, g[2] += p), h.push(["M", c[1], c[2]], ["L", k[1], k[2]], ["L", g[1], g[2]], ["L", b[1], b[2]], ["Z"]));
                        h.isFlat = d } }
                return h
            },
            ...
            addPlotBandOrLine: function(a, c) { var e = this,
                    f = new m(this, a),
                    h = this.userOptions;
                this.visible && (f = f.render()); if (f) { this._addedPlotLB || (this._addedPlotLB = !0, (h.plotLines || []).concat(h.plotBands || []).forEach(function(a) { e.addPlotBandOrLine(a) })); if (c) { var t = h[c] || [];
                        t.push(a);
                        h[c] = t }
            ...
            removePlotBandOrLine: function(a) {
                var c = this.plotLinesAndBands,
                    e = this.options,
                    f = this.userOptions;
                if (c) { for (var h = c.length; h--;) c[h].id === a && c[h].destroy();
    ...
    L(a, "Core/Tooltip.js", [a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/Renderer/RendererRegistry.js"], a["Core/Utilities.js"]], function(a, u, E,
        ...
        "";
        a = function() {
            function a(a, c) { this.container = void 0;
                this.crosshairs = [];
                this.distance = 0;
                this.isHidden = !0;
                this.isSticky = !1;
            ...
            a.prototype.cleanSplit = function(a) { this.chart.series.forEach(function(d) { var b = d && d.tt;
                    b && (!b.isActive || a ? d.tt = b.destroy() : b.isActive = !1) }) };
            a.prototype.defaultFormatter = function(a) { var d = this.points || J(this); var b = [a.tooltipFooterHeaderFormatter(d[0])];
                b = b.concat(a.bodyFormatter(d));
                b.push(a.tooltipFooterHeaderFormatter(d[0], !0)); return b };
            a.prototype.destroy = function() {
            ...
            a.prototype.getLabel = function() {
                var a = this,
                    ...
                    C = function() { var b = a.chart.hoverSeries;
                        a.inContact = !1; if (b && b.onMouseOut) b.onMouseOut() };
                if (!this.label) {
                    if (this.outside) {
                    ...
                    if (a.outside && !a.split) {
                        ...
                        n.ySetter = function(b) { v.call(n, a.distance);
                            l.style.top = b + "px" }
                    }
            ...
            a.prototype.getPosition = function(a, c, b) {
                var d = this.chart,
                    ...
                    J = function(b, a, d, g, c) { var r;
                        c < k || c > a - k ? r = !1 : e[b] = c < d / 2 ? 1 : c > a - g / 2 ? a - g - 2 : c - d / 2; return r },
                    u = function(b) { var a = q;
                        q = w;
                        w = a;
                        h = b },
            ...
            a.prototype.hide = function(a) { var d = this;
                x.clearTimeout(this.hideTimer);
                a = l(a, this.options.hideDelay, 500);
                this.isHidden || (this.hideTimer = K(function() { d.getLabel().fadeOut(a ? void 0 : a);
                    d.isHidden = !0 }, a)) };
            ...
            a.prototype.renderSplit = function(a, k) {
                ...
                var H = R,
                    ea = R;
                a.forEach(function(b) { var a = b.x,
                        g = b.boxWidth;
                    b = b.isHeader;
                ...
                a.forEach(function(b) { var a = b.x,
                        ...
                        c = b.pos,
                        k = b.point.isHeader;
                    c = { visibility: "undefined" === typeof c ? "hidden" : "inherit", x: a, y: c + V, anchorX: g, anchorY: b.anchorY }; if (d.outside && a < g) { var e = R - H;
            ...
            a.prototype.update = function(a) { this.destroy();
    ...
    L(a, "Core/Pointer.js", [a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/Tooltip.js"], a["Core/Utilities.js"]], function(a, u, E, H, x) {
        var v = a.parse,
            ...
            A = x.splat;
        a = function() {
            function a(a, c) { this.lastValidTouch = {};
                this.pinchDown = [];
            ...
            a.prototype.applyInactiveState = function(a) {
                var d = [],
                    b;
                (a || []).forEach(function(a) { b = a.series;
                    d.push(b);
            ...
            a.prototype.destroy = function() { var d = this;
            ...
            a.prototype.findNearestKDPoint =
                function(a, c, b) { var d = this.chart,
                        e = d.hoverPoint;
                    d = d.tooltip; if (e && d && d.isStickyOnContact()) return e; var k;
                    a.forEach(function(a) { var d = !(a.noSharedTooltip && c) && 0 > a.options.findNearestPointBy.indexOf("y");
                        a = a.searchPoint(b, d); if ((d = n(a, !0) && a.series) && !(d = !n(k, !0))) { d = k.distX - a.distX; var g = k.dist - a.dist,
            ...
            a.prototype.getChartCoordinatesFromPoint =
                function(a, c) { var b = a.series,
                        d = b.xAxis;
                    b = b.yAxis; var e = a.shapeArgs; if (d && b) { var k = K(a.clientX, a.plotX),
                            f = a.plotY || 0;
                        a.isNode && e && w(e.x) && w(e.y) && (k = e.x, f = e.y); return c ? { chartX: b.len + b.pos - f, chartY: d.len + d.pos - k } : { chartX: k + d.pos, chartY: f + b.pos } } if (e && e.x && e.y) return { chartX: e.x, chartY: e.y } };
            ...
            a.prototype.getCoordinates = function(a) { var d = { xAxis: [], yAxis: [] };
                this.chart.axes.forEach(function(b) { d[b.isXAxis ? "xAxis" : "yAxis"].push({ axis: b, value: b.toValue(a[b.horiz ? "chartX" : "chartY"]) }) }); return d };
            a.prototype.getHoverData = function(a, c, b, g, e, f) {
                ...
                c = r && r.series;
                r && (e && !c.noSharedTooltip ? (l = b.filter(function(b) { return k.filter ? k.filter(b) : b.visible && !(!e && b.directTouch) && K(b.options.enableMouseTracking, !0) && !b.noSharedTooltip }), l.forEach(function(b) { var a = t(b.points, function(b) { return b.x === r.x && !b.isNull });
            ...
            a.prototype.onTrackerMouseOut = function(a) { a = a.relatedTarget || a.toElement; var d = this.chart.hoverSeries;
                this.isDirectTouch = !1; if (!(!d || !a || d.stickyTracking || this.inClass(a, "highcharts-tooltip") || this.inClass(a, "highcharts-series-" + d.index) && this.inClass(a, "highcharts-tracker"))) d.onMouseOut() };
            a.prototype.inClass = function(a, c) { for (var b; a;) { if (b = h(a, "class")) { if (-1 !== b.indexOf(c)) return !0; if (-1 !== b.indexOf("highcharts-container")) return !1 }
                    a = a.parentNode } };
            a.prototype.init = function(a, c) { this.options = c;
                this.chart = a;
            ...
            a.prototype.onContainerMouseDown = function(a) { var d = 1 === ((a.buttons || a.button) & 1);
                a = this.normalize(a); if (u.isFirefox && 0 !== a.button) this.onContainerMouseMove(a); if ("undefined" === typeof a.button || d) this.zoomOption(a), d && a.preventDefault && a.preventDefault(), this.dragStart(a) };
            ...
            a.prototype.onDocumentTouchEnd = function(d) { var c = G[K(a.hoverChartIndex, -1)];
                c && c.pointer.drop(d) };
            a.prototype.onContainerTouchMove = function(a) { if (this.touchSelect(a)) this.onContainerMouseMove(a);
                else this.touch(a) };
            a.prototype.onContainerTouchStart = function(a) { if (this.touchSelect(a)) this.onContainerMouseDown(a);
            ...
            a.prototype.onDocumentMouseUp = function(d) { var c = G[K(a.hoverChartIndex, -1)];
                c && c.pointer.drop(d) };
            ...
            a.prototype.pinchTranslateDirection = function(a, c, b, g, e, f, l, h) {
                var d = this.chart,
                    ...
                    M = c[0][F],
                    q = !n && c[1][F];
                c = function() { "number" === typeof v && 20 < Math.abs(M - q) && (P = h || Math.abs(A - v) / Math.abs(M - q));
                    w = (m - A) / P + M;
            ...
            a.prototype.reset = function(a, c) {
                ...
                if (a) f && l && A(l).length && (f.refresh(l), f.shared && k ? k.forEach(function(a) {
                    ...
                    k && k.forEach(function(a) { a.setState() }); if (d) d.onMouseOut();
                    f && f.hide(c);
            ...
            a.prototype.runPointActions = function(d, c) {
                ...
                b.axes.forEach(function(a) { var c = K((a.crosshair || {}).snap, !0),
                        g;
            ...
            a.prototype.setHoverChartIndex = function() { var d = this.chart,
                    c = u.charts[K(a.hoverChartIndex, -1)]; if (c && c !== d) c.pointer.onContainerMouseLeave({ relatedTarget: !0 });
            ...
            a.prototype.touch = function(a, c) {
                ...
                if (1 === a.touches.length)
                    if (a = this.normalize(a), (d = b.isInsidePlot(a.chartX - b.plotLeft, a.chartY - b.plotTop, { visiblePlotOnly: !0 })) && !b.openMenu) { c && this.runPointActions(a); if ("touchmove" === a.type) { c = this.pinchDown; var e = c[0] ? 4 <= Math.sqrt(Math.pow(c[0].chartX - a.chartX, 2) + Math.pow(c[0].chartY - a.chartY, 2)) : !1 }
                        K(e, !0) && this.pinch(a) } else c && this.reset();
    ...
    L(a, "Core/MSPointer.js", [a["Core/Globals.js"], a["Core/Pointer.js"], a["Core/Utilities.js"]], function(a, u, E) {
        function v() { var a = [];
            ...
            e(m, function(c) { a.push({ pageX: c.pageX, pageY: c.pageY, target: c.target }) }); return a }
        ...
        var y = this && this.__extends || function() { var a = function(c, e) { a = Object.setPrototypeOf || { __proto__: [] }
                    instanceof Array && function(a, c) { a.__proto__ = c } || function(a, c) { for (var e in c) c.hasOwnProperty(e) && (a[e] = c[e]) }; return a(c, e) }; return function(c, e) {
                    function f() { this.constructor = c }
                    a(c, e);
                    c.prototype = null === e ? Object.create(e) : (f.prototype = e.prototype, new f) } }(),
            G = a.charts,
        ...
        return function(e) {
            ...
            l.prototype.destroy = function() { this.batchMSEvents(t);
                e.prototype.destroy.call(this) };
            l.prototype.init = function(a, f) { e.prototype.init.call(this, a, f);
            ...
            l.prototype.setDOMEvents = function() { e.prototype.setDOMEvents.call(this);
    ...
    L(a, "Core/Series/Point.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Animation/AnimationUtilities.js"], a["Core/FormatUtilities.js"],
        ...
        u = function() {
            ...
            g.prototype.animateBeforeDestroy = function() { var a = this,
                    b = { x: a.startXPos, opacity: 0 },
                    d, c = a.getGraphicalProps();
                c.singular.forEach(function(c) { d = "dataLabel" === c;
            ...
            g.prototype.destroyElements = function(a) { var b = this;
                a = b.getGraphicalProps(a);
                a.singular.forEach(function(a) { b[a] = b[a].destroy() });
                a.plural.forEach(function(a) { b[a].forEach(function(a) { a.element && a.destroy() });
                    delete b[a] }) };
            ...
            g.prototype.getGraphicalProps = function(a) {
                ...
                for (c = d.length; c--;) { var e = d[c];
                    b[e] && g.singular.push(e) }["dataLabel", "connector"].forEach(function(d) { var c = d + "s";
            ...
            g.prototype.getZone = function() { var a = this.series,
                    b = a.zones;
                a = a.zoneAxis || "y"; var d = 0,
                    c; for (c = b[d]; this[a] >= c.value;) c = b[++d];
            ...
            g.prototype.init = function(a, d, c) { this.series = a;
                this.applyOptions(d, c);
                this.id = f(this.id) ? this.id : b();
                this.resolveColor();
                a.chart.pointCount++;
                t(this, "afterInit"); return this };
            ...
            g.prototype.resolveColor = function() {
                ...
                if (a.options.colorByPoint) {
                    if (!d) { b = a.options.colors || a.chart.options.colors; var c = b[a.colorCounter];
                        b = b.length }
                    d = a.colorCounter;
                    a.colorCounter++;
            ...
            g.prototype.tooltipFormatter = function(a) {
                ...
                (b.pointArrayMap || ["y"]).forEach(function(b) { b = "{point." + b; if (g || e) a = a.replace(RegExp(b + "}", "g"), g + b + "}" + e);
            ...
            g.prototype.onMouseOver = function(a) { var b = this.series.chart,
                    d = b.pointer;
                a = a ? d.normalize(a) : d.getChartCoordinatesFromPoint(this, b.inverted);
                d.runPointActions(a, this) };
            g.prototype.onMouseOut = function() { var a = this.series.chart;
            ...
            g.prototype.setState = function(b, d) {
                ...
                if (!(b === this.state && !d || this.selected && "select" !== b || !1 ===
                    ...
                    if (this.graphic && !this.hasDummyGraphic) {
                        ...
                        if (b && r) { g = F.symbol || c.symbol;
                            n && n.currentSymbol !== g && (n = n.destroy()); if (A)
    ...
    L(a, "Core/Legend.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Series/Point.js"], a["Core/Utilities.js"]], function(a, u, E, H, x) {
        ...
        var d = function() {
            ...
            a.prototype.setOptions = function(a) { var b = J(a.padding, 8);
                this.options = a;
            ...
            a.prototype.update = function(a, d) { var b = this.chart;
            ...
            a.prototype.positionItems = function() { this.allItems.forEach(this.positionItem, this);
            ...
            a.prototype.destroyItem = function(a) { var b = a.checkbox;
            ...
            a.prototype.positionCheckboxes = function() { var a = this.group && this.group.alignAttr,
                    d = this.clipHeight || this.legendHeight,
                    e = this.titleHeight; if (a) { var f = a.translateY;
                    this.allItems.forEach(function(b) { var g = b.checkbox; if (g) { var k = f + e + g.y + (this.scrollOffset || 0) + 3;
                            c(g, { left: a.translateX + b.checkboxOffset + g.x - 20 + "px", top: k + "px", display: this.proximate || k > f - 6 && k < f + d - 6 ? "" : "none" }) } }, this) } };
            ...
            a.prototype.setText = function(a) { var b = this.options;
            ...
            a.prototype.handleOverflow = function(a) {
                ...
                var l = e.maxHeight,
                    ...
                    N = function(a) { b[a] = c.circle(0, 0, 1.3 * n).translate(n / 2, n / 2).add(w);
                ...
                a && 0 < f && a > f && !1 !== p.enabled ? (this.clipHeight = h = Math.max(f - 20 - this.titleHeight - k, 0), this.currentPage = J(this.currentPage, 1), this.fullHeight =
                    a, A.forEach(function(a, b) { var d = a._legendItemPos[1],
                            c = Math.round(a.legendItem.getBBox().height),
                            e = q.length; if (!e || d - q[e - 1] > h && (v || d) !== q[e - 1]) q.push(v || d), e++;
                        a.pageIx = e - 1;
                        v && (A[b - 1].pageIx = e - 1);
                        b === A.length - 1 && d + c - q[e - 1] > h && d !== v && (q.push(d), a.pageIx = e);
                        d !== v && (v = d) }), m || (m = b.clipRect = c.clipRect(0, k, 9999, 0), b.contentGroup.clip(m)), I(h), w || (this.nav = w = c.g().attr({ zIndex: 1 }).add(this.group), this.up = c.symbol("triangle", 0, 0, n, n).add(w), N("upTracker").on("click", function() { b.scroll(-1, t) }), this.pager =
            ...
            a.prototype.setItemEvents = function(a, d, c) {
                ...
                (c ? [d, a.legendSymbol] : [a.legendGroup]).forEach(function(c) {
                    if (c) c.on("mouseover", function() { a.visible && b.allItems.forEach(function(b) { a !== b && b.setState("inactive", !g) });
                        a.setState("hover");
                        a.visible && e.addClass(f);
                        k || d.css(b.options.itemHoverStyle) }).on("mouseout", function() {
                        ...
                        e.removeClass(f);
                        a.setState()
                    }).on("click", function(d) { var c = function() { a.setVisible && a.setVisible();
        ...
        (/Trident\/7\.0/.test(u.navigator && u.navigator.userAgent) || a) && x(d.prototype, "positionItem", function(a, b) { var d = this,
    ...
    L(a, "Core/Series/SeriesRegistry.js", [a["Core/Globals.js"], a["Core/DefaultOptions.js"], a["Core/Series/Point.js"], a["Core/Utilities.js"]],
        function(a, u, E, H) {
            var v = u.defaultOptions,
                ...
                q;
            (function(h) {
                function f(a, e) { var c = v.plotOptions || {},
                        f = e.defaultOptions;
                ...
                h.getSeries = function(a, e) { void 0 === e && (e = {}); var c = a.options.chart;
                    c = e.type || c.type || c.defaultSeriesType || ""; var f = h.seriesTypes[c];
                    h || y(17, !0, a, { missingModuleFor: c });
                    c = new f; "function" === typeof c.init && c.init(a, e); return c };
                h.registerSeriesType = f;
                h.seriesType = function(a, e, t, m, w) { var c = v.plotOptions || {};
                    e = e || "";
                    c[a] = B(c[e], t);
                    f(a, G(h.seriesTypes[e] || function() {}, m));
                    h.seriesTypes[a].prototype.type = a;
                    w && (h.seriesTypes[a].prototype.pointClass = G(E, w)); return h.seriesTypes[a] }
            })(q || (q = {}));
    ...
    L(a, "Core/Chart/Chart.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Axis/Axis.js"], a["Core/FormatUtilities.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Core/Legend.js"], a["Core/MSPointer.js"],
        ...
        a = function() {
            ...
            a.prototype.initSeries = function(a) { var b = this.options.chart;
                b = a.type || b.type || b.defaultSeriesType; var d = r[b];
                d || ba(17, !0, this, { missingModuleFor: b });
                b = new d; "function" === typeof b.init && b.init(this, a); return b };
            ...
            a.prototype.orderSeries = function(a) { var b = this.series;
                a = a || 0; for (var d = b.length; a < d; ++a) b[a] && (b[a].index = a, b[a].name = b[a].getName()) };
            a.prototype.isInsidePlot = function(a, b, d) {
                ...
                if (!d.ignoreX) { var r = I && (c ? I.yAxis : I.xAxis) || { pos: g, len: Infinity };
                    k = d.paneCoordinates ? r.pos + k : g + k;
                    k >= Math.max(l + g, r.pos) && k <= Math.min(l + g + e.width, r.pos + r.len) || (a.isInsidePlot = !1) }!d.ignoreY &&
            ...
            a.prototype.redraw = function(a) {
                ...
                d.forEach(function(a) { a.isDirty && ("point" === a.options.legendType ? ("function" === typeof a.updateTotals && a.updateTotals(), r = !0) : g && (g.labelFormatter || g.labelFormat) && (r = !0));
                    a.isDirtyData && L(a, "updatedData") });
                r && e &&
                    e.options.enabled && (e.render(), this.isDirtyLegend = !1);
                p && this.getStacks();
                b.forEach(function(a) { a.updateNames();
                    a.setScale() });
                this.getMargins();
                b.forEach(function(a) { a.isDirty && (I = !0) });
                b.forEach(function(a) { var b = a.min + "," + a.max;
                    a.extKey !== b && (a.extKey = b, h.push(function() { L(a, "afterSetExtremes", z(a.eventArgs, a.getExtremes()));
                        delete a.eventArgs }));
                    (I || p) && a.redraw() });
                I && this.drawChartBox();
                L(this, "predraw");
            ...
            a.prototype.get = function(a) {
                function b(b) { return b.id === a || b.options && b.options.id === a } for (var d = this.series, c = Q(this.axes, b) || Q(this.series, b), e = 0; !c && e < d.length; e++) c = Q(d[e].points || [], b); return c };
            ...
            a.prototype.getSelectedPoints = function() { var a = [];
                this.series.forEach(function(b) { a = a.concat(b.getPointsCollection().filter(function(a) { return R(a.selectedStaging, a.selected) })) }); return a };
            ...
            a.prototype.getChartSize = function() { var a = this.options.chart,
                    b = a.width;
            ...
            a.prototype.temporaryDisplay = function(a) {
                ...
                if (a)
                    ...
                    for (; b && b.style;) { p.body.contains(b) || b.parentNode || (b.hcOrigDetached = !0, p.body.appendChild(b)); if ("none" === aa(b, "display", !1) || b.hcOricDetached) b.hcOrigStyle = { display: b.style.display, height: b.style.height, overflow: b.style.overflow }, a = { display: "block", overflow: "hidden" }, b !== this.renderTo && (a.height = 0), O(b, a), b.offsetWidth || b.style.setProperty("display", "block", "important");
                        b = b.parentNode; if (b === p.body) break }
            };
            ...
            a.prototype.getAxisMargins = function() { var a = this,
            ...
            a.prototype.reflow = function(a) {
                ...
                if (!e && !b.isPrinting && g && d && (c === k || c === p)) { if (g !== b.containerWidth || d !== b.containerHeight) t.clearTimeout(b.reflowTimeout), b.reflowTimeout = ea(function() { b.container && b.setSize(void 0, void 0, !1) }, a ? 100 : 0);
                    b.containerWidth = g;
                    b.containerHeight = d }
            };
            ...
            a.prototype.setSize =
                function(a, b, d) {
                    ...
                    c.axes.forEach(function(a) { a.isDirty = !0;
                        a.setScale() });
                    c.isDirtyLegend = !0;
                    c.isDirtyBox = !0;
                    c.layOutTitles();
            ...
            a.prototype.resetMargins = function() { L(this, "resetMargins"); var a = this,
                    b = a.options.chart;
            ...
            a.prototype.linkSeries = function() { var a = this,
                    b = a.series;
            ...
            a.prototype.renderLabels = function() { var a = this,
                    b = a.options.labels;
                b.items && b.items.forEach(function(d) { var c = z(b.style, d.style),
            ...
            a.prototype.render = function() {
                ...
                if (k || l) a.forEach(function(a) {
                    (a.horiz && k || !a.horiz && l) && a.setTickInterval(!0) }), this.getMargins();
                this.drawChartBox();
            ...
            a.prototype.addCredits = function(a) {
                ...
                d.enabled && !this.credits && (this.credits = this.renderer.text(d.text + (this.mapCredits || ""), 0, 0).addClass("highcharts-credits").on("click", function() { d.href && (k.location.href = d.href) }).attr({ align: d.position.align, zIndex: 8 }), b.styledMode ||
                    this.credits.css(d.style), this.credits.add().align(d.position), this.credits.update = function(a) { b.credits = b.credits.destroy();
                        b.addCredits(a) })
            };
            a.prototype.destroy = function() {
                var a = this,
            ...
            a.prototype.addSeries = function(a, b, d) { var c = this,
                    e;
                a && (b = R(b, !0), L(c, "addSeries", { options: a }, function() { e = c.initSeries(a);
                    c.isDirtyLegend = !0;
                    c.linkSeries();
                    e.enabledDataSorting && e.setData(a.data, !1);
                    L(c, "afterAddSeries", { series: e });
                    b && c.redraw(d) })); return e };
            ...
            a.prototype.createAxis =
                function(a, b) { var d = "colorAxis" === a,
                        c = b.redraw,
                        e = b.animation;
                    a = U(b.axis, { index: this[a].length, isX: "xAxis" === a });
                    a = d ? new x.ColorAxis(this, a) : new u(this, a);
                    d && (this.isDirtyLegend = !0, this.axes.forEach(function(a) { a.series = [] }), this.series.forEach(function(a) { a.bindAxes();
                        a.isDirtyData = !0 }));
                    R(c, !0) && this.redraw(e); return a };
            ...
            a.prototype.update = function(a, b, d, c) {
                ...
                f.userOptions = U(f.userOptions,
                    a);
                var p = a.chart;
                if (p) { U(!0, f.options.chart, p); "className" in p && f.setClassName(p.className); "reflow" in p && f.setReflow(p.reflow); if ("inverted" in p || "polar" in p || "type" in p) { f.propFromSeries(); var t = !0 } "alignTicks" in p && (t = !0); "events" in p && K(this, p);
                    T(p, function(a, b) {-1 !== f.propsRequireUpdateSeries.indexOf("chart." + b) && (r = !0); - 1 !== f.propsRequireDirtyBox.indexOf(b) && (f.isDirtyBox = !0); - 1 !== f.propsRequireReflow.indexOf(b) && (l ? f.isDirtyBox = !0 : m = !0) });!f.styledMode && "style" in p && f.renderer.setStyle(p.style) }!f.styledMode &&
                    a.colors && (this.options.colors = a.colors);
                a.time && (this.time === g && (this.time = new e(a.time)), U(!0, f.options.time, a.time));
                T(a, function(b, d) { if (f[d] && "function" === typeof f[d].update) f[d].update(b, !1);
                    else if ("function" === typeof f[k[d]]) f[k[d]](b);
                    else "colors" !== d && -1 === f.collectionsWithUpdate.indexOf(d) && U(!0, f.options[d], a[d]); "chart" !== d && -1 !== f.propsRequireUpdateSeries.indexOf(d) && (r = !0) });
                this.collectionsWithUpdate.forEach(function(b) {
                    if (a[b]) {
                        ...
                        fa(a[b]).forEach(function(a, e) { var g = S(a.id),
                                k;
                            g && (k = f.get(a.id));!k && f[b] && (k = f[b][c ? c[e] : e]) && g && S(k.options.id) && (k = void 0);
                            k && k.coll === b && (k.update(a, !1), d && (k.touched = !0));!k && d && f.collectionsWithInit[b] && (f.collectionsWithInit[b][0].apply(f, [a].concat(f.collectionsWithInit[b][1] || []).concat([!1])).touched = !0) });
            ...
            a.prototype.setSubtitle = function(a, b) { this.applyDescription("subtitle", a);
                this.layOutTitles(b) };
            a.prototype.setCaption = function(a, b) { this.applyDescription("caption", a);
                this.layOutTitles(b) };
            a.prototype.showResetZoom =
                function() {
                    function a() { d.zoomOut() } var d = this,
                        c = b.lang,
            ...
            a.prototype.zoom = function(a) {
                var b = this,
                    ...
                    e = !1,
                    g;
                !a || a.resetSelection ? (b.axes.forEach(function(a) { g = a.zoom() }), d.initiated = !1) : a.xAxis.concat(a.yAxis).forEach(function(a) { var f = a.axis,
                        k = b.inverted ? f.left : f.top,
                        l = b.inverted ? k + f.width : k + f.height,
                        h = f.isXAxis,
                        I = !1; if (!h && c >= k && c <= l || h || !S(c)) I = !0;
    ...
    L(a, "Core/Series/Series.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Mixins/LegendSymbol.js"], a["Core/DefaultOptions.js"], a["Core/Color/Palette.js"], a["Core/Series/Point.js"],
        ...
        a = function() {
            ...
            a.prototype.insert = function(a) { var b = this.options.index,
                    d; if (S(b)) { for (d = a.length; d--;)
                        if (b >= z(a[d].options.index, a[d]._i)) { a.splice(d + 1, 0, this); break } - 1 === d && a.unshift(this);
                    d += 1 } else a.push(this); return z(d, a.length - 1) };
            ...
            a.prototype.updateParallelArrays = function(a, b) { var d = a.series,
                    c = arguments,
                    e = S(b) ? function(c) { var e = "y" === c && d.toYData ? d.toYData(a) : a[c];
                        d[c + "Data"][b] = e } : function(a) { Array.prototype[b].apply(d[a + "Data"], Array.prototype.slice.call(c, 2)) };
            ...
            a.prototype.setDataSortingOptions = function() { var a = this.options;
            ...
            a.prototype.findPointIndex = function(a, b) {
                ...
                else if (this.linkedParent || this.enabledDataSorting) { var l = f && f.matchByName ? "name" : "index";
                    k = D(e, function(b) { return !b.touched && b[l] === a[l] }); if (!k) return }
                if (k) {
                    var h = k && k.index;
                    "undefined" !== typeof h &&
                        (g = !0)
            ...
            a.prototype.sortData = function(a) {
                ...
                a.forEach(function(b,
                    c) { a[c] = e(d, b);
                    a[c].index = c }, this);
                a.concat().sort(function(a, b) { a = C(c, a);
                    b = C(c, b); return b < a ? -1 : b > a ? 1 : 0 }).forEach(function(a, b) { a.x = b }, this);
                d.linkedSeries && d.linkedSeries.forEach(function(b) { var d = b.options,
                        c = d.data;
                    d.dataSorting && d.dataSorting.enabled || !c || (c.forEach(function(d, g) { c[g] = e(b, d);
                        a[g] && (c[g].x = a[g].x, c[g].index = g) }), b.setData(c, !1)) });
                return a
            };
            a.prototype.getProcessedData = function(a) {
                ...
                if (h && this.sorted && !l && (!k || c > k || this.forceCrop))
                    ...
                    else if (this.yData && (b[0] < p || b[c - 1] > t)) { e = this.cropData(this.xData, this.yData, p, t);
                    b = e.xData;
                    d = e.yData;
                    e = e.start; var I = !0 }
                for (k = b.length || 1; --k;)
            ...
            a.prototype.processData = function(a) { var b = this.xAxis; if (this.isCartesian && !this.isDirty && !b.isDirty && !this.yAxis.isDirty && !a) return !1;
            ...
            a.prototype.generatePoints = function() {
                ...
                for (p = 0; p < k; p++) {
                    var t =
                        l + p;
                    if (h) { var n = (new f).init(this, [e[p]].concat(ia(g[p])));
                        n.dataGroup = this.groupMap[a + p];
                        n.dataGroup.options && (n.options = n.dataGroup.options, F(n, n.dataGroup.options), delete n.dataLabels) } else(n = d[t]) || "undefined" === typeof b[t] || (d[t] = n = (new f).init(this, b[t], e[p]));
            ...
            a.prototype.applyExtremes = function() { var a = this.getExtremes();
                this.dataMin = a.dataMin;
                this.dataMax = a.dataMax; return a };
            ...
            a.prototype.animate = function(a) { var b = this.chart,
                    d = f(this.options.animation),
                    c = this.sharedClipKey; if (a) this.setClip(d);
                else if (c) { a = b.sharedClips[c];
                    c = b.sharedClips[c + "m"]; var e = this.getClipBox(d, !0);
                    a && a.animate(e, d);
            ...
            a.prototype.markerAttribs = function(a, b) { var d = this.options,
                    c = d.marker,
                    e = a.marker || {},
                    g = e.symbol || c.symbol,
            ...
            a.prototype.searchPoint = function(a, b) { var d = this.xAxis,
                    c = this.yAxis,
            ...
            a.prototype.buildKDTree = function(a) {
                ...
                delete d.kdTree;
                aa(function() { d.kdTree = b(d.getValidPoints(null, !d.directTouch), c, c);
            ...
            a.prototype.pointPlacementToXValue =
                function() { var a = this.options,
                        b = a.pointRange,
                        d = this.xAxis;
                    a = a.pointPlacement; "between" === a && (a = d.reversed ? -.5 : .5); return S(a) ? a * (b || d.pointRange) : 0 };
            ...
            a.prototype.removePoint = function(a, b, d) {
                var e = this,
                    ...
                    k = e.points,
                    l = e.chart,
                    h = function() { k && k.length === g.length && k.splice(a, 1);
                        g.splice(a, 1);
            ...
            a.prototype.remove = function(a, b, d, c) {
                function e() { g.destroy(c);
                    f.isDirtyLegend = f.isDirtyBox = !0;
                    f.linkSeries();
                    z(a, !0) && f.redraw(b) } var g = this,
                    f = g.chart;!1 !== d ? M(g, "remove", null, e) : e() };
            a.prototype.update = function(a, b) {
                ...
                n.forEach(function(a) { n[a] = c[a];
                    delete c[a] });
                g = !1;
                if (l[h]) { if (g = h !== c.type, c.remove(!1, !1, !1, !0), g)
                        if (Object.setPrototypeOf) Object.setPrototypeOf(c, l[h].prototype);
                        else { k = Object.hasOwnProperty.call(c, "hcEvents") && c.hcEvents; for (t in m) c[t] = void 0;
                            F(c, l[h].prototype);
                            k ? c.hcEvents = k : delete c.hcEvents } } else r(17, !0, e, { missingModuleFor: h });
                n.forEach(function(a) { c[a] = n[a] });
                c.init(e, a);
                if (p && this.points) { var A = c.options;!1 === A.visible ? (w.graphic = 1, w.dataLabel = 1) : c._hasPointLabels || (a = A.marker, h = A.dataLabels, a && (!1 === a.enabled || "symbol" in a) && (w.graphic = 1), h && !1 === h.enabled && (w.dataLabel = 1));
            ...
            a.prototype.setName = function(a) { this.name = this.options.name = this.userOptions.name = a;
                this.chart.isDirtyLegend = !0 };
            a.prototype.hasOptionChanged = function(a) { var b = this.options[a],
                    d = this.chart.options.plotOptions,
                    c = this.userOptions[a]; return c ? b !== c : b !== z(d && d[this.type] && d[this.type][a], d && d.series && d.series[a], b) };
            ...
            a.prototype.onMouseOut = function() { var a = this.options,
                    b = this.chart,
                    d = b.tooltip,
                    c = b.hoverPoint;
                b.hoverSeries = null; if (c) c.onMouseOut();
                this && a.events.mouseOut && M(this, "mouseOut");!d || this.stickyTracking || d.shared && !this.noSharedTooltip || d.hide();
            ...
            a.prototype.select = function(a) { this.selected = a = this.options.selected = "undefined" === typeof a ? !this.selected : a;
                this.checkbox && (this.checkbox.checked = a);
                M(this, a ? "select" : "unselect") };
            a.prototype.shouldShowTooltip = function(a, b, d) { void 0 === d && (d = {});
                d.series = this;
                d.visiblePlotOnly = !0; return this.chart.isInsidePlot(a, b, d) };
            a.defaultOptions = {
                lineWidth: 2,
                allowPointSelect: !1,
                crisp: !0,
            ...
            if (!this.renderer.forExport) {
                if (f) {
                    if (this.scrollablePixelsX =
                        f = Math.max(0, f - this.chartWidth)) { this.scrollablePlotBox = this.renderer.scrollablePlotBox = h(this.plotBox);
                        this.plotBox.width = this.plotWidth += f;
                        this.inverted ? this.clipBox.height += f : this.clipBox.width += f; var m = { 1: { name: "right", value: f } } }
                ...
                m && !a.skipAxes && this.axes.forEach(function(a) { m[a.side] ? a.getPlotLinePath = function() { var c = m[a.side].name,
                            e = this[c];
                        this[c] = e - m[a.side].value; var f = u.prototype.getPlotLinePath.apply(this, arguments);
                        this[c] = e; return f } : (a.setAxisSize(), a.setAxisTranslation()) })
            }
        });
    ...
    L(a, "Core/Axis/StackingAxis.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Utilities.js"]], function(a, u) {
        var v = a.getDeferredAnimation,
            ...
            B = u.objectEach,
            q = function() {
                function a(a) { this.oldStacks = {};
                    this.stacks = {};
                    this.stacksTouched = 0;
                    this.axis = a }
                a.prototype.buildStacks = function() { var a = this.axis,
                        c = a.series,
                        e = a.options.reversedStacks,
                        h = c.length,
                        m; if (!a.isXAxis) { this.usePercentage = !1; for (m = h; m--;) { var q = c[e ? m : h - m - 1];
                            q.setStackedPoints();
                            q.setGroupedPoints() } for (m = 0; m < h; m++) c[m].modifyStacks();
        ...
        return function() {
            function a() {}
            a.compose = function(f) { H(f, "init", a.onInit);
                H(f, "destroy", a.onDestroy) };
            a.onDestroy = function() { var a = this.stacking; if (a) { var c = a.stacks;
                    B(c, function(a, f) { x(a);
                        c[f] = null });
                    a && a.stackTotalGroup && a.stackTotalGroup.destroy() } };
            a.onInit = function() { this.stacking || (this.stacking = new q(this)) }; return a }()
    });
    L(a, "Extensions/Stacking.js", [a["Core/Axis/Axis.js"], a["Core/Chart/Chart.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Series/Series.js"], a["Core/Axis/StackingAxis.js"], a["Core/Utilities.js"]], function(a, u, E, H, x, y, G) {
        ...
        y.compose(a);
        x.prototype.setGroupedPoints = function() { var a = this.yAxis.stacking;
        ...
        x.prototype.modifyStacks = function() {
            ...
            a[p + "Stacker"] && [c, "-" + c].forEach(function(d) { for (var c = f.length, b, g; c--;)
                    if (b = f[c], h = a.getStackIndicator(h, b, a.index, d), g = (b = e[d] && e[d][b]) && b.points[h.key]) a[p + "Stacker"](g, b, c) })
        };
        x.prototype.percentStacker = function(a, c, e) { c = c.total ? 100 / c.total : 0;
            a[0] = q(a[0] * c);
            a[1] = q(a[1] * c);
            this.stackedYData[e] = a[1] };
        x.prototype.getStackIndicator = function(a, c, e, f) {!h(a) || a.x !== c || f && a.key !== f ? a = { x: c, index: 0, key: f } : a.index++;
    ...
    L(a, "Series/Line/LineSeries.js", [a["Core/Color/Palette.js"], a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function(a, u, E, H) {
        var v = this && this.__extends || function() { var a = function(q, h) { a = Object.setPrototypeOf || { __proto__: [] }
                    instanceof Array && function(a, c) { a.__proto__ = c } || function(a, c) { for (var e in c) c.hasOwnProperty(e) && (a[e] = c[e]) }; return a(q, h) }; return function(q, h) {
            ...
            G = H.merge;
        H = function(B) {
            function q() { var a = null !== B && B.apply(this, arguments) || this;
                a.data = void 0;
                a.options = void 0;
                a.points = void 0; return a }
            v(q, B);
            ...
            q.prototype.getZonesGraphs = function(a) { this.zones.forEach(function(f, c) { c = ["zone-graph-" + c, "highcharts-graph highcharts-zone-graph-" + c + " " + (f.className || "")];
    ...
    L(a, "Series/Area/AreaSeries.js", [a["Core/Color/Color.js"], a["Mixins/LegendSymbol.js"],
        ...
        var v = this && this.__extends || function() { var a = function(c, e) { a = Object.setPrototypeOf || { __proto__: [] }
                    instanceof Array && function(a, c) { a.__proto__ = c } || function(a, c) { for (var e in c) c.hasOwnProperty(e) && (a[e] = c[e]) }; return a(c, e) }; return function(c, e) {
                    function f() { this.constructor = c }
                    a(c, e);
                    c.prototype = null === e ? Object.create(e) : (f.prototype = e.prototype, new f) } }(),
        ...
        var B = H.merge,
            ...
            h = H.pick;
        H = function(a) {
            function c() { var c = null !== a && a.apply(this, arguments) || this;
                c.data = void 0;
                c.options = void 0;
            ...
            c.prototype.getGraphPath = function(a) {
                ...
                var b = function(b, c, e) { var g = a[b];
                    b = f && p[g.x].points[u]; var h = g[e + "Null"] || 0;
                    e = g[e + "Cliff"] || 0;
                    g = !0; if (e || h) { var l = (h ? b[0] : b[1]) + e; var m = b[0] + e;
                        g = !!h } else !f && a[c] && a[c].isNull && (l = m = d); "undefined" !== typeof l && (v.push({ plotX: r, plotY: null === l ? k : n.getThreshold(l), isNull: g, isCliff: !0 }), q.push({ plotX: r, plotY: null === m ? k : n.getThreshold(m), doCurve: !1 })) };
                a = a || this.points;
                    ...
                    f.forEach(function(a, b) {
                        ...
                        if (u[a] && !u[a].isNull) e.push(u[a]), [-1, 1].forEach(function(e) {
                            var h = 1 === e ? "rightNull" :
                                ...
                                r = v[f[b + e]];
                            if (r)
                                for (var n = k; 0 <= n && n < p;) { var q = A[n].index;
                                    m = r.points[q];
                                    m || (q === c.index ? u[a][h] = !0 : g[n] && (t = v[a].points[q]) && (l -= t[1] - t[0]));
                                    n += d }
                            u[a][1 === e ? "rightCliff" : "leftCliff"] = l
                        });
                        else { for (var q = k; 0 <= q && q < p;) { if (m = v[a].points[A[q].index]) { r = m[1]; break }
                                q += d }
                            r = h(r, 0);
    ...
    L(a, "Series/Spline/SplineSeries.js", [a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function(a, u) {
        var v = this && this.__extends || function() {
                var a = function(v, q) { a = Object.setPrototypeOf || { __proto__: [] }
                    instanceof Array && function(a, f) { a.__proto__ = f } || function(a, f) { for (var c in f) f.hasOwnProperty(c) && (a[c] = f[c]) }; return a(v, q) };
                return function(v, q) {
            ...
            y = u.pick;
        u = function(a) {
            function u() { var q = null !== a && a.apply(this, arguments) || this;
                q.data = void 0;
                q.options = void 0;
                q.points = void 0; return q }
            v(u, a);
    ...
    L(a, "Series/AreaSpline/AreaSplineSeries.js", [a["Series/Area/AreaSeries.js"],
        ...
        var v = this && this.__extends || function() { var a = function(f, c) { a = Object.setPrototypeOf || { __proto__: [] }
                    instanceof Array && function(a, c) { a.__proto__ = c } || function(a, c) { for (var e in c) c.hasOwnProperty(e) && (a[e] = c[e]) }; return a(f, c) }; return function(f, c) {
                    function e() { this.constructor = f }
                    a(f, c);
                    f.prototype = null === c ? Object.create(c) : (e.prototype = c.prototype, new e) } }(),
            G =
            ...
            q = x.merge;
        x = function(h) {
            function f() { var a = null !== h && h.apply(this, arguments) || this;
                a.data = void 0;
                a.points = void 0;
                a.options = void 0; return a }
            v(f, h);
            f.defaultOptions = q(u.defaultOptions, a.defaultOptions); return f }(u);
    ...
    L(a, "Series/Column/ColumnSeries.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Color/Color.js"],
        ...
        var q = this && this.__extends || function() {
                var a = function(d, b) { a = Object.setPrototypeOf || { __proto__: [] }
                    instanceof Array && function(a, b) { a.__proto__ = b } || function(a, b) { for (var d in b) b.hasOwnProperty(d) && (a[d] = b[d]) }; return a(d, b) };
                return function(d, b) {
        ...
        var e = B.clamp,
            ...
            p = B.objectEach;
        B = function(a) {
            function d() { var b = null !== a && a.apply(this, arguments) || this;
            ...
            d.prototype.animate = function(a) {
                ...
                else { var p = Number(b.group.attr(l));
                    b.group.animate({ scaleY: 1 }, v(h(b.options.animation), { step: function(a, c) { b.group && (k[l] = p + c.pos * (d.pos - p), b.group.attr(k)) } })) }
            };
            d.prototype.init = function(b, d) { a.prototype.init.apply(this, arguments); var c = this;
                b = c.chart;
            ...
            d.prototype.getColumnMetrics = function() {
                ...
                var k, l = {},
                    h = 0;
                !1 === d.grouping ? h = 1 : a.chart.series.forEach(function(b) { var d = b.yAxis,
                        c = b.options; if (b.type === a.type && (b.visible || !a.chart.options.chart.ignoreHiddenSeries) && e.len === d.len && e.pos === d.pos) { if (c.stacking && "group" !== c.stacking) { k = b.stackKey; "undefined" === typeof l[k] && (l[k] = h++); var f = l[k] } else !1 !== c.grouping && (f = h++);
                        b.columnIndex = f } });
            ...
            d.prototype.adjustForMissingColumns = function(a, d, c, e) {
                ...
                if (!c.isNull && 1 < e.columnCount) {
                    var g = 0,
                        k = 0;
                    p(this.yAxis.stacking && this.yAxis.stacking.stacks, function(a) { if ("number" === typeof c.x && (a = a[c.x.toString()])) { var d = a.points[b.index],
                                e = a.total;
            ...
            d.prototype.translate = function() {
                ...
                a.points.forEach(function(b) {
                    ...
                    var F = v,
                        D = Math.min(g, f),
                        z = Math.max(g, f) - D;
                    if (t && Math.abs(z) < t) { z = t; var B = !l.reversed && !b.negative || l.reversed && b.negative;
            ...
            d.prototype.pointAttribs = function(a, d) {
                ...
                if (a && this.zones.length) { var m = a.getZone();
            ...
            d.prototype.drawTracker = function() {
                var a = this,
                    ...
                    k;
                a.points.forEach(function(a) { k = l(a.dataLabels) ? a.dataLabels : a.dataLabel ? [a.dataLabel] : [];
            ...
            d.prototype.remove = function() { var a = this,
                    d = a.chart;
    ...
    L(a, "Series/Bar/BarSeries.js", [a["Series/Column/ColumnSeries.js"], a["Core/Series/SeriesRegistry.js"],
        ...
        var v = this && this.__extends || function() { var a = function(v, q) { a = Object.setPrototypeOf || { __proto__: [] }
                    instanceof Array && function(a, f) { a.__proto__ = f } || function(a, f) { for (var c in f) f.hasOwnProperty(c) && (a[c] = f[c]) }; return a(v, q) }; return function(v, q) {
                    function h() { this.constructor = v }
                    a(v, q);
    ...
    L(a, "Series/Scatter/ScatterSeries.js", [a["Series/Column/ColumnSeries.js"], a["Series/Line/LineSeries.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function(a, u, E, H) {
        var v = this && this.__extends || function() {
            ...
            B = H.merge;
        H = function(a) {
            function h() { var f = null !== a && a.apply(this, arguments) || this;
                f.data = void 0;
                f.options = void 0;
                f.points = void 0; return f }
            v(h, a);
            h.prototype.applyJitter = function() {
                ...
                c && this.points.forEach(function(f,
                    h) {
                    ["x", "y"].forEach(function(m, t) { var l = "plot" + m.toUpperCase(); if (c[m] && !f.isNull) { var n = a[m + "Axis"]; var q = c[m] * n.transA; if (n && !n.isLog) { var v = Math.max(0, f[l] - q);
                                n = Math.min(n.len, f[l] + q);
                                t = 1E4 * Math.sin(h + t * e);
                                f[l] = v + (n - v) * (t - Math.floor(t)); "x" === m && (f.clientX = f.plotX) } } }) })
            };
    ...
    L(a, "Mixins/CenteredSeries.js", [a["Core/Globals.js"], a["Core/Series/Series.js"], a["Core/Utilities.js"]], function(a, u, E) {
        ...
        return a.CenteredSeriesMixin = {
            ...
            getStartAndEndRadians: function(a, q) { a = v(a) ? a : 0;
                q = v(q) && q > a && 360 > q - a ? q : a + 360; return { start: G * (a + -90), end: G * (q + -90) } }
        }
    });
    L(a, "Series/Pie/PiePoint.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Series/Point.js"], a["Core/Utilities.js"]], function(a, u, E) {
        var v = this && this.__extends || function() {
                var a =
                    function(c, e) { a = Object.setPrototypeOf || { __proto__: [] }
                        instanceof Array && function(a, c) { a.__proto__ = c } || function(a, c) { for (var e in c) c.hasOwnProperty(e) && (a[e] = c[e]) }; return a(c, e) };
                return function(c, e) {
                    function f() { this.constructor = c }
                    a(c, e);
                    c.prototype = null === e ? Object.create(e) : (f.prototype = e.prototype, new f) }
        ...
        E = function(a) {
            ...
            v(c, a);
            c.prototype.getConnectorPath = function() { var a = this.labelPosition,
                    c = this.series.options.dataLabels,
                    f = c.connectorShape,
                    h = this.connectorShapes;
                h[f] && (f = h[f]); return f.call(this, { x: a.final.x, y: a.final.y, alignment: a.alignment }, a.connectorPosition, c) };
            ...
            c.prototype.init = function() { u.prototype.init.apply(this, arguments); var a = this;
                a.name = q(a.name, "Slice"); var c = function(c) { a.slice("select" === c.type) };
                y(a, "select", c);
            ...
            c.prototype.slice = function(a, c, f) { var e = this.series;
                x(f, e.chart);
                q(c, !0);
        ...
        a(E.prototype, {
            connectorShapes: {
                fixedOffset: function(a, c, e) { var f = c.breakAt;
                    c = c.touchingSliceAt; return [
                        ["M", a.x, a.y], e.softConnector ? ["C", a.x + ("left" === a.alignment ? -5 : 5), a.y, 2 * f.x - c.x, 2 * f.y - c.y, f.x, f.y] : ["L", f.x, f.y],
                        ["L", c.x, c.y]
                    ] },
                straight: function(a, c) { c = c.touchingSliceAt; return [
                        ["M", a.x, a.y],
                        ["L", c.x, c.y]
                    ] },
    ...
    L(a, "Series/Pie/PieSeries.js", [a["Mixins/CenteredSeries.js"], a["Series/Column/ColumnSeries.js"], a["Core/Globals.js"], a["Mixins/LegendSymbol.js"], a["Core/Color/Palette.js"], a["Series/Pie/PiePoint.js"], a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Renderer/SVG/Symbols.js"], a["Core/Utilities.js"]],
        function(a, u, E, H, x, y, G, B, q, h) {
            var f = this && this.__extends || function() { var a = function(c, e) { a = Object.setPrototypeOf || { __proto__: [] }
                        instanceof Array && function(a, c) { a.__proto__ = c } || function(a, c) { for (var d in c) c.hasOwnProperty(d) && (a[d] = c[d]) }; return a(c, e) }; return function(c, e) {
                        function f() { this.constructor = c }
                        a(c, e);
                        c.prototype = null === e ? Object.create(e) : (f.prototype = e.prototype, new f) } }(),
            ...
            h =
                function(a) {
                    function h() { var c = null !== a && a.apply(this, arguments) || this;
                        c.center = void 0;
                        c.data = void 0;
                        ...
                        c.points = void 0; return c }
                    f(h, a);
                    h.prototype.animate = function(a) { var c = this,
                            d = c.points,
                            e = c.startAngleRad;
                        a || d.forEach(function(a) { var b = a.graphic,
                                d = a.shapeArgs;
                    ...
                    h.prototype.drawEmpty = function() {
                        var a = this.startAngleRad,
                            c = this.endAngleRad,
                            d = this.options;
                        if (0 === this.total && this.center) { var e = this.center[0]; var b = this.center[1];
                            ...
                            this.chart.styledMode || this.graph.attr({ "stroke-width": d.borderWidth, fill: d.fillColor || "none", stroke: d.color || x.neutralColor20 }) } else this.graph && (this.graph = this.graph.destroy())
                    };
                    ...
                    h.prototype.generatePoints = function() { a.prototype.generatePoints.call(this);
                        this.updateTotals() };
    ...
    L(a, "Core/Series/DataLabels.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function(a, u, E, H, x, y, G) {
        ...
        E.distribute = function(a, c, e) {
            ...
            if (p > n) { A(a, function(a, b) { return (b.rank || 0) - (a.rank || 0) }); for (p = d = 0; p <= n;) p += a[d].size, d++;
        ...
        y.pie && (y.pie.prototype.dataLabelPositioners = {
                ...
                alignToConnectors: function(a,
                    c, e, b) { var d = 0,
                        f;
                    a.forEach(function(a) { f = a.dataLabel.getBBox().width;
                        f > d && (d = f) }); return c ? d + b : e - d - b }
                ...
                a.visible && (f.enabled || a._hasPointLabels) && (d.forEach(function(a) {
                    ...
                    if (h) {
                        ...
                        for (U = 0; U < h; U++) {
                            ...
                            if (f.justify) I = R.justify(e, B, y);
                                ...
                                case "connectors":
                                    I = R.alignToConnectors(d, g, q, v); break;
                                case "plotEdges":
                                    I = R.alignToPlotEdges(z, g, q, v); break;
                                default:
                    ...
                    delete a.distributeBox }, this) }, y.pie.prototype.alignDataLabel = a, y.pie.prototype.verifyDataLabelOverflow =
            function(a) { var c = this.center,
                    e = this.options,
                    b = e.center,
                    g = e.minSize || 80,
                    h = null !== e.size; if (!h) { if (null !== b[0]) var l = Math.max(c[2] - Math.max(a[1], a[3]), g);
                    else l = Math.max(c[2] - a[1] - a[3], g), c[0] += (a[3] - a[1]) / 2;
                    null !== b[1] ? l = f(l, g, c[2] - Math.max(a[0], a[2])) : (l = f(l, g, c[2] - a[0] - a[2]), c[1] += (a[0] - a[2]) / 2);
                    l < c[2] ? (c[2] = l, c[3] = Math.min(J(e.innerSize || 0, l), l), this.translate(c), this.drawDataLabels && this.drawDataLabels()) : h = !0 } return h });
    ...
    L(a, "Extensions/OverlappingDataLabels.js", [a["Core/Chart/Chart.js"], a["Core/Utilities.js"]], function(a, u) {
        ...
        H(a, "render", function() {
            ...
            (this.series || []).forEach(function(c) {
                ...
                c.visible && (!1 !== e.enabled || c._hasPointLabels) && (e = function(c) { return c.forEach(function(c) { c.visible && (y(c.dataLabels) ? c.dataLabels : c.dataLabel ? [c.dataLabel] : []).forEach(function(e) { var h = e.options;
                            e.labelrank = q(h.labelrank, c.labelrank, c.shapeArgs && c.shapeArgs.height);
                            h.allowOverlap ? (e.oldOpacity = e.opacity, e.newOpacity = 1, v(e, a)) : f.push(e) }) }) }, e(c.nodes || []), e(c.points))
            });
        ...
        function(a) {
            var v = a.extend,
                ...
                f = function() {
                    ...
                    a.prototype.matchResponsiveRule = function(a, c) { var e = a.condition;
                    ...
                    a.prototype.setResponsive = function(a, c) {
                        var e = this.options.responsive,
                            ...
                            n = [];
                        !c &&
                            e && e.rules && e.rules.forEach(function(a) { "undefined" === typeof a._id && (a._id = h());
                                this.matchResponsiveRule(a, n) }, this);
            ...
            a = function() {
                function a() {}
                a.compose = function(a) { v(a.prototype, f.prototype); return a }; return a }();
            "";
            "";
            return a
        });
