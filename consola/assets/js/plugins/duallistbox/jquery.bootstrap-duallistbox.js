;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoTextFiltered: '<span class="label label-warning">Coincidencias</span> {0} de {1}', // when not all of the options are visible due to the filter
      infoTextEmpty: 'Sin datos',                                                        // when there are no options present in the list
