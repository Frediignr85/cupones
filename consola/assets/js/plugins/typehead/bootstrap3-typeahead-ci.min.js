...
$.fn.typeahead.Constructor.prototype.normalize = function (str) {
    ...
    normalized = normalized.replace(/[AÁ]/gi, '[AÁ]');
    normalized = normalized.replace(/[EÉ]/gi, '[EÉ]');
    normalized = normalized.replace(/[IÍ]/gi, '[IÍ]');
    normalized = normalized.replace(/[OÓ]/gi, '[OÓ]');
    normalized = normalized.replace(/[UÚ]/gi, '[UÚ]');
